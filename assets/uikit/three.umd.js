...
}`;function Pf(i,t,e){let n=new jr;const r=new At,o=new At,a=new ne,s=new Rf({depthPacking:jl}),l=new Cf,c={},d=e.maxTextureSize,f={[Qe]:be,[be]:Qe,[Ge]:Ge},h=new xn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new At},radius:{value:4}},vertexShader:kf,fragmentShader:Lf}),p=h.clone();p.defines.HORIZONTAL_PASS=1;const v=new Ce;v.setAttribute("position",new Fe(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const _=new Oe(v,h),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Mo;let u=this.type;this.render=function(S,R,C){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||S.length===0)return;const U=i.getRenderTarget(),b=i.getActiveCubeFace(),T=i.getActiveMipmapLevel(),B=i.state;B.setBlending(tn),B.buffers.color.setClear(1,1,1,1),B.buffers.depth.setTest(!0),B.setScissorTest(!1);const q=u!==He&&this.type===He,K=u===He&&this.type!==He;for(let L=0,G=S.length;L<G;L++){const Y=S[L],W=Y.shadow;if(W===void 0){console.warn("THREE.WebGLShadowMap:",Y,"has no shadow.");continue}if(W.autoUpdate===!1&&W.needsUpdate===!1)continue;r.copy(W.mapSize);const Q=W.getFrameExtents();if(r.multiply(Q),o.copy(W.mapSize),(r.x>d||r.y>d)&&(r.x>d&&(o.x=Math.floor(d/Q.x),r.x=o.x*Q.x,W.mapSize.x=o.x),r.y>d&&(o.y=Math.floor(d/Q.y),r.y=o.y*Q.y,W.mapSize.y=o.y)),W.map===null||q===!0||K===!0){const $=this.type!==He?{minFilter:he,magFilter:he}:{};W.map!==null&&W.map.dispose(),W.map=new mn(r.x,r.y,$),W.map.texture.name=Y.name+".shadowMap",W.camera.updateProjectionMatrix()}i.setRenderTarget(W.map),i.clear();const X=W.getViewportCount();for(let $=0;$<X;$++){const P=W.getViewport($);a.set(o.x*P.x,o.y*P.y,o.x*P.z,o.y*P.w),B.viewport(a),W.updateMatrices(Y,$),n=W.getFrustum(),M(R,C,W.camera,Y,this.type)}W.isPointLightShadow!==!0&&this.type===He&&w(W,C),W.needsUpdate=!1}u=this.type,m.needsUpdate=!1,i.setRenderTarget(U,b,T)};function w(S,R){const C=t.update(_);h.defines.VSM_SAMPLES!==S.blurSamples&&(h.defines.VSM_SAMPLES=S.blurSamples,p.defines.VSM_SAMPLES=S.blurSamples,h.needsUpdate=!0,p.needsUpdate=!0),S.mapPass===null&&(S.mapPass=new mn(r.x,r.y)),h.uniforms.shadow_pass.value=S.map.texture,h.uniforms.resolution.value=S.mapSize,h.uniforms.radius.value=S.radius,i.setRenderTarget(S.mapPass),i.clear(),i.renderBufferDirect(R,null,C,h,_,null),p.uniforms.shadow_pass.value=S.mapPass.texture,p.uniforms.resolution.value=S.mapSize,p.uniforms.radius.value=S.radius,i.setRenderTarget(S.map),i.clear(),i.renderBufferDirect(R,null,C,p,_,null)}function g(S,R,C,U){let b=null;const T=C.isPointLight===!0?S.customDistanceMaterial:S.customDepthMaterial;if(T!==void 0)b=T;else if(b=C.isPointLight===!0?l:s,i.localClippingEnabled&&R.clipShadows===!0&&Array.isArray(R.clippingPlanes)&&R.clippingPlanes.length!==0||R.displacementMap&&R.displacementScale!==0||R.alphaMap&&R.alphaTest>0||R.map&&R.alphaTest>0){const B=b.uuid,q=R.uuid;let K=c[B];K===void 0&&(K={},c[B]=K);let L=K[q];L===void 0&&(L=b.clone(),K[q]=L),b=L}if(b.visible=R.visible,b.wireframe=R.wireframe,U===He?b.side=R.shadowSide!==null?R.shadowSide:R.side:b.side=R.shadowSide!==null?R.shadowSide:f[R.side],b.alphaMap=R.alphaMap,b.alphaTest=R.alphaTest,b.map=R.map,b.clipShadows=R.clipShadows,b.clippingPlanes=R.clippingPlanes,b.clipIntersection=R.clipIntersection,b.displacementMap=R.displacementMap,b.displacementScale=R.displacementScale,b.displacementBias=R.displacementBias,b.wireframeLinewidth=R.wireframeLinewidth,b.linewidth=R.linewidth,C.isPointLight===!0&&b.isMeshDistanceMaterial===!0){const B=i.properties.get(b);B.light=C}return b}function M(S,R,C,U,b){if(S.visible===!1)return;if(S.layers.test(R.layers)&&(S.isMesh||S.isLine||S.isPoints)&&(S.castShadow||S.receiveShadow&&b===He)&&(!S.frustumCulled||n.intersectsObject(S))){S.modelViewMatrix.multiplyMatrices(C.matrixWorldInverse,S.matrixWorld);const q=t.update(S),K=S.material;if(Array.isArray(K)){const L=q.groups;for(let G=0,Y=L.length;G<Y;G++){const W=L[G],Q=K[W.materialIndex];if(Q&&Q.visible){const X=g(S,Q,U,b);i.renderBufferDirect(C,null,q,X,S,W)}}}else if(K.visible){const L=g(S,K,U,b);i.renderBufferDirect(C,null,q,L,S,null)}}const B=S.children;for(let q=0,K=B.length;q<K;q++)M(B[q],R,C,U,b)}}function Df(i,t,e){const n=e.isWebGL2;function r(){let A=!1;const rt=new ne;let it=null;const ht=new ne(0,0,0,0);return{setMask:function(lt){it!==lt&&!A&&(i.colorMask(lt,lt,lt,lt),it=lt)},setLocked:function(lt){A=lt},setClear:function(lt,j,mt,kt,ge){ge===!0&&(lt*=kt,j*=kt,mt*=kt),rt.set(lt,j,mt,kt),ht.equals(rt)===!1&&(i.clearColor(lt,j,mt,kt),ht.copy(rt))},reset:function(){A=!1,it=null,ht.set(-1,0,0,0)}}}function o(){let A=!1,rt=null,it=null,ht=null;return{setTest:function(lt){lt?F(i.DEPTH_TEST):Z(i.DEPTH_TEST)},setMask:function(lt){rt!==lt&&!A&&(i.depthMask(lt),rt=lt)},setFunc:function(lt){if(it!==lt){switch(lt){case Ml:i.depthFunc(i.NEVER);break;case Sl:i.depthFunc(i.ALWAYS);break;case El:i.depthFunc(i.LESS);break;case fr:i.depthFunc(i.LEQUAL);break;case Tl:i.depthFunc(i.EQUAL);break;case Al:i.depthFunc(i.GEQUAL);break;case Rl:i.depthFunc(i.GREATER);break;case Cl:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}it=lt}},setLocked:function(lt){A=lt},setClear:function(lt){ht!==lt&&(i.clearDepth(lt),ht=lt)},reset:function(){A=!1,rt=null,it=null,ht=null}}}function a(){let A=!1,rt=null,it=null,ht=null,lt=null,j=null,mt=null,kt=null,ge=null;return{setTest:function(qt){A||(qt?F(i.STENCIL_TEST):Z(i.STENCIL_TEST))},setMask:function(qt){rt!==qt&&!A&&(i.stencilMask(qt),rt=qt)},setFunc:function(qt,ze,_e){(it!==qt||ht!==ze||lt!==_e)&&(i.stencilFunc(qt,ze,_e),it=qt,ht=ze,lt=_e)},setOp:function(qt,ze,_e){(j!==qt||mt!==ze||kt!==_e)&&(i.stencilOp(qt,ze,_e),j=qt,mt=ze,kt=_e)},setLocked:function(qt){A=qt},setClear:function(qt){ge!==qt&&(i.clearStencil(qt),ge=qt)},reset:function(){A=!1,rt=null,it=null,ht=null,lt=null,j=null,mt=null,kt=null,ge=null}}}const s=new r,l=new o,c=new a,d=new WeakMap,f=new WeakMap;let h={},p={},v=new WeakMap,_=[],m=null,u=!1,w=null,g=null,M=null,S=null,R=null,C=null,U=null,b=!1,T=null,B=null,q=null,K=null,L=null;const G=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let Y=!1,W=0;const Q=i.getParameter(i.VERSION);Q.indexOf("WebGL")!==-1?(W=parseFloat(/^WebGL (\d)/.exec(Q)[1]),Y=W>=1):Q.indexOf("OpenGL ES")!==-1&&(W=parseFloat(/^OpenGL ES (\d)/.exec(Q)[1]),Y=W>=2);let X=null,$={};const P=i.getParameter(i.SCISSOR_BOX),V=i.getParameter(i.VIEWPORT),at=new ne().fromArray(P),ct=new ne().fromArray(V);function dt(A,rt,it,ht){const lt=new Uint8Array(4),j=i.createTexture();i.bindTexture(A,j),i.texParameteri(A,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(A,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let mt=0;mt<it;mt++)n&&(A===i.TEXTURE_3D||A===i.TEXTURE_2D_ARRAY)?i.texImage3D(rt,0,i.RGBA,1,1,ht,0,i.RGBA,i.UNSIGNED_BYTE,lt):i.texImage2D(rt+mt,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,lt);return j}const xt={};xt[i.TEXTURE_2D]=dt(i.TEXTURE_2D,i.TEXTURE_2D,1),xt[i.TEXTURE_CUBE_MAP]=dt(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),n&&(xt[i.TEXTURE_2D_ARRAY]=dt(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),xt[i.TEXTURE_3D]=dt(i.TEXTURE_3D,i.TEXTURE_3D,1,1)),s.setClear(0,0,0,1),l.setClear(1),c.setClear(0),F(i.DEPTH_TEST),l.setFunc(fr),Rt(!1),Yt(yo),F(i.CULL_FACE),gt(tn);function F(A){h[A]!==!0&&(i.enable(A),h[A]=!0)}function Z(A){h[A]!==!1&&(i.disable(A),h[A]=!1)}function _t(A,rt){return p[A]!==rt?(i.bindFramebuffer(A,rt),p[A]=rt,n&&(A===i.DRAW_FRAMEBUFFER&&(p[i.FRAMEBUFFER]=rt),A===i.FRAMEBUFFER&&(p[i.DRAW_FRAMEBUFFER]=rt)),!0):!1}function Ht(A,rt){let it=_,ht=!1;if(A)if(it=v.get(rt),it===void 0&&(it=[],v.set(rt,it)),A.isWebGLMultipleRenderTargets){const lt=A.texture;if(it.length!==lt.length||it[0]!==i.COLOR_ATTACHMENT0){for(let j=0,mt=lt.length;j<mt;j++)it[j]=i.COLOR_ATTACHMENT0+j;it.length=lt.length,ht=!0}}else it[0]!==i.COLOR_ATTACHMENT0&&(it[0]=i.COLOR_ATTACHMENT0,ht=!0);else it[0]!==i.BACK&&(it[0]=i.BACK,ht=!0);ht&&(e.isWebGL2?i.drawBuffers(it):t.get("WEBGL_draw_buffers").drawBuffersWEBGL(it))}function wt(A){return m!==A?(i.useProgram(A),m=A,!0):!1}const D={[Pn]:i.FUNC_ADD,[hl]:i.FUNC_SUBTRACT,[fl]:i.FUNC_REVERSE_SUBTRACT};if(n)D[Ao]=i.MIN,D[Ro]=i.MAX;else{const A=t.get("EXT_blend_minmax");A!==null&&(D[Ao]=A.MIN_EXT,D[Ro]=A.MAX_EXT)}const ae={[pl]:i.ZERO,[ml]:i.ONE,[gl]:i.SRC_COLOR,[Co]:i.SRC_ALPHA,[yl]:i.SRC_ALPHA_SATURATE,[bl]:i.DST_COLOR,[vl]:i.DST_ALPHA,[_l]:i.ONE_MINUS_SRC_COLOR,[ko]:i.ONE_MINUS_SRC_ALPHA,[wl]:i.ONE_MINUS_DST_COLOR,[xl]:i.ONE_MINUS_DST_ALPHA};function gt(A,rt,it,ht,lt,j,mt,kt){if(A===tn){u===!0&&(Z(i.BLEND),u=!1);return}if(u===!1&&(F(i.BLEND),u=!0),A!==dl){if(A!==w||kt!==b){if((g!==Pn||R!==Pn)&&(i.blendEquation(i.FUNC_ADD),g=Pn,R=Pn),kt)switch(A){case Ln:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case So:i.blendFunc(i.ONE,i.ONE);break;case Eo:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case To:i.blendFuncSeparate(i.ZERO,i.SRC_COLOR,i.ZERO,i.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",A);break}else switch(A){case Ln:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case So:i.blendFunc(i.SRC_ALPHA,i.ONE);break;case Eo:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case To:i.blendFunc(i.ZERO,i.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",A);break}M=null,S=null,C=null,U=null,w=A,b=kt}return}lt=lt||rt,j=j||it,mt=mt||ht,(rt!==g||lt!==R)&&(i.blendEquationSeparate(D[rt],D[lt]),g=rt,R=lt),(it!==M||ht!==S||j!==C||mt!==U)&&(i.blendFuncSeparate(ae[it],ae[ht],ae[j],ae[mt]),M=it,S=ht,C=j,U=mt),w=A,b=!1}function Pt(A,rt){A.side===Ge?Z(i.CULL_FACE):F(i.CULL_FACE);let it=A.side===be;rt&&(it=!it),Rt(it),A.blending===Ln&&A.transparent===!1?gt(tn):gt(A.blending,A.blendEquation,A.blendSrc,A.blendDst,A.blendEquationAlpha,A.blendSrcAlpha,A.blendDstAlpha,A.premultipliedAlpha),l.setFunc(A.depthFunc),l.setTest(A.depthTest),l.setMask(A.depthWrite),s.setMask(A.colorWrite);const ht=A.stencilWrite;c.setTest(ht),ht&&(c.setMask(A.stencilWriteMask),c.setFunc(A.stencilFunc,A.stencilRef,A.stencilFuncMask),c.setOp(A.stencilFail,A.stencilZFail,A.stencilZPass)),It(A.polygonOffset,A.polygonOffsetFactor,A.polygonOffsetUnits),A.alphaToCoverage===!0?F(i.SAMPLE_ALPHA_TO_COVERAGE):Z(i.SAMPLE_ALPHA_TO_COVERAGE)}function Rt(A){T!==A&&(A?i.frontFace(i.CW):i.frontFace(i.CCW),T=A)}function Yt(A){A!==ll?(F(i.CULL_FACE),A!==B&&(A===yo?i.cullFace(i.BACK):A===cl?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):Z(i.CULL_FACE),B=A}function Ot(A){A!==q&&(Y&&i.lineWidth(A),q=A)}function It(A,rt,it){A?(F(i.POLYGON_OFFSET_FILL),(K!==rt||L!==it)&&(i.polygonOffset(rt,it),K=rt,L=it)):Z(i.POLYGON_OFFSET_FILL)}function Wt(A){A?F(i.SCISSOR_TEST):Z(i.SCISSOR_TEST)}function le(A){A===void 0&&(A=i.TEXTURE0+G-1),X!==A&&(i.activeTexture(A),X=A)}function de(A,rt,it){it===void 0&&(X===null?it=i.TEXTURE0+G-1:it=X);let ht=$[it];ht===void 0&&(ht={type:void 0,texture:void 0},$[it]=ht),(ht.type!==A||ht.texture!==rt)&&(X!==it&&(i.activeTexture(it),X=it),i.bindTexture(A,rt||xt[A]),ht.type=A,ht.texture=rt)}function E(){const A=$[X];A!==void 0&&A.type!==void 0&&(i.bindTexture(A.type,null),A.type=void 0,A.texture=void 0)}function x(){try{i.compressedTexImage2D.apply(i,arguments)}catch(A){console.error("THREE.WebGLState:",A)}}function O(){try{i.compressedTexImage3D.apply(i,arguments)}catch(A){console.error("THREE.WebGLState:",A)}}function et(){try{i.texSubImage2D.apply(i,arguments)}catch(A){console.error("THREE.WebGLState:",A)}}function J(){try{i.texSubImage3D.apply(i,arguments)}catch(A){console.error("THREE.WebGLState:",A)}}function nt(){try{i.compressedTexSubImage2D.apply(i,arguments)}catch(A){console.error("THREE.WebGLState:",A)}}function pt(){try{i.compressedTexSubImage3D.apply(i,arguments)}catch(A){console.error("THREE.WebGLState:",A)}}function ot(){try{i.texStorage2D.apply(i,arguments)}catch(A){console.error("THREE.WebGLState:",A)}}function ut(){try{i.texStorage3D.apply(i,arguments)}catch(A){console.error("THREE.WebGLState:",A)}}function Mt(){try{i.texImage2D.apply(i,arguments)}catch(A){console.error("THREE.WebGLState:",A)}}function zt(){try{i.texImage3D.apply(i,arguments)}catch(A){console.error("THREE.WebGLState:",A)}}function tt(A){at.equals(A)===!1&&(i.scissor(A.x,A.y,A.z,A.w),at.copy(A))}function Vt(A){ct.equals(A)===!1&&(i.viewport(A.x,A.y,A.z,A.w),ct.copy(A))}function Ct(A,rt){let it=f.get(rt);it===void 0&&(it=new WeakMap,f.set(rt,it));let ht=it.get(A);ht===void 0&&(ht=i.getUniformBlockIndex(rt,A.name),it.set(A,ht))}function St(A,rt){const ht=f.get(rt).get(A);d.get(rt)!==ht&&(i.uniformBlockBinding(rt,ht,A.__bindingPointIndex),d.set(rt,ht))}function bt(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),n===!0&&(i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null)),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),h={},X=null,$={},p={},v=new WeakMap,_=[],m=null,u=!1,w=null,g=null,M=null,S=null,R=null,C=null,U=null,b=!1,T=null,B=null,q=null,K=null,L=null,at.set(0,0,i.canvas.width,i.canvas.height),ct.set(0,0,i.canvas.width,i.canvas.height),s.reset(),l.reset(),c.reset()}return{buffers:{color:s,depth:l,stencil:c},enable:F,disable:Z,bindFramebuffer:_t,drawBuffers:Ht,useProgram:wt,setBlending:gt,setMaterial:Pt,setFlipSided:Rt,setCullFace:Yt,setLineWidth:Ot,setPolygonOffset:It,setScissorTest:Wt,activeTexture:le,bindTexture:de,unbindTexture:E,compressedTexImage2D:x,compressedTexImage3D:O,texImage2D:Mt,texImage3D:zt,updateUBOMapping:Ct,uniformBlockBinding:St,texStorage2D:ot,texStorage3D:ut,texSubImage2D:et,texSubImage3D:J,compressedTexSubImage2D:nt,compressedTexSubImage3D:pt,scissor:tt,viewport:Vt,reset:bt}}function Uf(i,t,e,n,r,o,a){const s=r.isWebGL2,l=r.maxTextures,c=r.maxCubemapSize,d=r.maxTextureSize,f=r.maxSamples,h=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,p=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),v=new WeakMap;let _;const m=new WeakMap;let u=!1;try{u=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function w(E,x){return u?new OffscreenCanvas(E,x):Li("canvas")}function g(E,x,O,et){let J=1;if((E.width>et||E.height>et)&&(J=et/Math.max(E.width,E.height)),J<1||x===!0)if(typeof HTMLImageElement<"u"&&E instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&E instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&E instanceof ImageBitmap){const nt=x?ki:Math.floor,pt=nt(J*E.width),ot=nt(J*E.height);_===void 0&&(_=w(pt,ot));const ut=O?w(pt,ot):_;return ut.width=pt,ut.height=ot,ut.getContext("2d").drawImage(E,0,0,pt,ot),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+E.width+"x"+E.height+") to ("+pt+"x"+ot+")."),ut}else return"data"in E&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+E.width+"x"+E.height+")."),E;return E}function M(E){return kr(E.width)&&kr(E.height)}function S(E){return s?!1:E.wrapS!==Pe||E.wrapT!==Pe||E.minFilter!==he&&E.minFilter!==Te}function R(E,x){return E.generateMipmaps&&x&&E.minFilter!==he&&E.minFilter!==Te}function C(E){i.generateMipmap(E)}function U(E,x,O,et,J=!1){if(s===!1)return x;if(E!==null){if(i[E]!==void 0)return i[E];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+E+"'")}let nt=x;if(x===i.RED&&(O===i.FLOAT&&(nt=i.R32F),O===i.HALF_FLOAT&&(nt=i.R16F),O===i.UNSIGNED_BYTE&&(nt=i.R8)),x===i.RED_INTEGER&&(O===i.UNSIGNED_BYTE&&(nt=i.R8UI),O===i.UNSIGNED_SHORT&&(nt=i.R16UI),O===i.UNSIGNED_INT&&(nt=i.R32UI),O===i.BYTE&&(nt=i.R8I),O===i.SHORT&&(nt=i.R16I),O===i.INT&&(nt=i.R32I)),x===i.RG&&(O===i.FLOAT&&(nt=i.RG32F),O===i.HALF_FLOAT&&(nt=i.RG16F),O===i.UNSIGNED_BYTE&&(nt=i.RG8)),x===i.RGBA){const pt=J?Ti:Gt.getTransfer(et);O===i.FLOAT&&(nt=i.RGBA32F),O===i.HALF_FLOAT&&(nt=i.RGBA16F),O===i.UNSIGNED_BYTE&&(nt=pt===Xt?i.SRGB8_ALPHA8:i.RGBA8),O===i.UNSIGNED_SHORT_4_4_4_4&&(nt=i.RGBA4),O===i.UNSIGNED_SHORT_5_5_5_1&&(nt=i.RGB5_A1)}return(nt===i.R16F||nt===i.R32F||nt===i.RG16F||nt===i.RG32F||nt===i.RGBA16F||nt===i.RGBA32F)&&t.get("EXT_color_buffer_float"),nt}function b(E,x,O){return R(E,O)===!0||E.isFramebufferTexture&&E.minFilter!==he&&E.minFilter!==Te?Math.log2(Math.max(x.width,x.height))+1:E.mipmaps!==void 0&&E.mipmaps.length>0?E.mipmaps.length:E.isCompressedTexture&&Array.isArray(E.image)?x.mipmaps.length:1}function T(E){return E===he||E===Po||E===xr?i.NEAREST:i.LINEAR}function B(E){const x=E.target;x.removeEventListener("dispose",B),K(x),x.isVideoTexture&&v.delete(x)}function q(E){const x=E.target;x.removeEventListener("dispose",q),G(x)}function K(E){const x=n.get(E);if(x.__webglInit===void 0)return;const O=E.source,et=m.get(O);if(et){const J=et[x.__cacheKey];J.usedTimes--,J.usedTimes===0&&L(E),Object.keys(et).length===0&&m.delete(O)}n.remove(E)}function L(E){const x=n.get(E);i.deleteTexture(x.__webglTexture);const O=E.source,et=m.get(O);delete et[x.__cacheKey],a.memory.textures--}function G(E){const x=E.texture,O=n.get(E),et=n.get(x);if(et.__webglTexture!==void 0&&(i.deleteTexture(et.__webglTexture),a.memory.textures--),E.depthTexture&&E.depthTexture.dispose(),E.isWebGLCubeRenderTarget)for(let J=0;J<6;J++){if(Array.isArray(O.__webglFramebuffer[J]))for(let nt=0;nt<O.__webglFramebuffer[J].length;nt++)i.deleteFramebuffer(O.__webglFramebuffer[J][nt]);else i.deleteFramebuffer(O.__webglFramebuffer[J]);O.__webglDepthbuffer&&i.deleteRenderbuffer(O.__webglDepthbuffer[J])}else{if(Array.isArray(O.__webglFramebuffer))for(let J=0;J<O.__webglFramebuffer.length;J++)i.deleteFramebuffer(O.__webglFramebuffer[J]);else i.deleteFramebuffer(O.__webglFramebuffer);if(O.__webglDepthbuffer&&i.deleteRenderbuffer(O.__webglDepthbuffer),O.__webglMultisampledFramebuffer&&i.deleteFramebuffer(O.__webglMultisampledFramebuffer),O.__webglColorRenderbuffer)for(let J=0;J<O.__webglColorRenderbuffer.length;J++)O.__webglColorRenderbuffer[J]&&i.deleteRenderbuffer(O.__webglColorRenderbuffer[J]);O.__webglDepthRenderbuffer&&i.deleteRenderbuffer(O.__webglDepthRenderbuffer)}if(E.isWebGLMultipleRenderTargets)for(let J=0,nt=x.length;J<nt;J++){const pt=n.get(x[J]);pt.__webglTexture&&(i.deleteTexture(pt.__webglTexture),a.memory.textures--),n.remove(x[J])}n.remove(x),n.remove(E)}let Y=0;function W(){Y=0}function Q(){const E=Y;return E>=l&&console.warn("THREE.WebGLTextures: Trying to use "+E+" texture units while this GPU supports only "+l),Y+=1,E}function X(E){const x=[];return x.push(E.wrapS),x.push(E.wrapT),x.push(E.wrapR||0),x.push(E.magFilter),x.push(E.minFilter),x.push(E.anisotropy),x.push(E.internalFormat),x.push(E.format),x.push(E.type),x.push(E.generateMipmaps),x.push(E.premultiplyAlpha),x.push(E.flipY),x.push(E.unpackAlignment),x.push(E.colorSpace),x.join()}function $(E,x){const O=n.get(E);if(E.isVideoTexture&&le(E),E.isRenderTargetTexture===!1&&E.version>0&&O.__version!==E.version){const et=E.image;if(et===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(et.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{_t(O,E,x);return}}e.bindTexture(i.TEXTURE_2D,O.__webglTexture,i.TEXTURE0+x)}function P(E,x){const O=n.get(E);if(E.version>0&&O.__version!==E.version){_t(O,E,x);return}e.bindTexture(i.TEXTURE_2D_ARRAY,O.__webglTexture,i.TEXTURE0+x)}function V(E,x){const O=n.get(E);if(E.version>0&&O.__version!==E.version){_t(O,E,x);return}e.bindTexture(i.TEXTURE_3D,O.__webglTexture,i.TEXTURE0+x)}function at(E,x){const O=n.get(E);if(E.version>0&&O.__version!==E.version){Ht(O,E,x);return}e.bindTexture(i.TEXTURE_CUBE_MAP,O.__webglTexture,i.TEXTURE0+x)}const ct={[_r]:i.REPEAT,[Pe]:i.CLAMP_TO_EDGE,[vr]:i.MIRRORED_REPEAT},dt={[he]:i.NEAREST,[Po]:i.NEAREST_MIPMAP_NEAREST,[xr]:i.NEAREST_MIPMAP_LINEAR,[Te]:i.LINEAR,[Fl]:i.LINEAR_MIPMAP_NEAREST,[ui]:i.LINEAR_MIPMAP_LINEAR},xt={[Kl]:i.NEVER,[rc]:i.ALWAYS,[Jl]:i.LESS,[tc]:i.LEQUAL,[Ql]:i.EQUAL,[ic]:i.GEQUAL,[ec]:i.GREATER,[nc]:i.NOTEQUAL};function F(E,x,O){if(O?(i.texParameteri(E,i.TEXTURE_WRAP_S,ct[x.wrapS]),i.texParameteri(E,i.TEXTURE_WRAP_T,ct[x.wrapT]),(E===i.TEXTURE_3D||E===i.TEXTURE_2D_ARRAY)&&i.texParameteri(E,i.TEXTURE_WRAP_R,ct[x.wrapR]),i.texParameteri(E,i.TEXTURE_MAG_FILTER,dt[x.magFilter]),i.texParameteri(E,i.TEXTURE_MIN_FILTER,dt[x.minFilter])):(i.texParameteri(E,i.TEXTURE_WRAP_S,i.CLAMP_TO_EDGE),i.texParameteri(E,i.TEXTURE_WRAP_T,i.CLAMP_TO_EDGE),(E===i.TEXTURE_3D||E===i.TEXTURE_2D_ARRAY)&&i.texParameteri(E,i.TEXTURE_WRAP_R,i.CLAMP_TO_EDGE),(x.wrapS!==Pe||x.wrapT!==Pe)&&console.warn("THREE.WebGLRenderer: Texture is not power of two. Texture.wrapS and Texture.wrapT should be set to THREE.ClampToEdgeWrapping."),i.texParameteri(E,i.TEXTURE_MAG_FILTER,T(x.magFilter)),i.texParameteri(E,i.TEXTURE_MIN_FILTER,T(x.minFilter)),x.minFilter!==he&&x.minFilter!==Te&&console.warn("THREE.WebGLRenderer: Texture is not power of two. Texture.minFilter should be set to THREE.NearestFilter or THREE.LinearFilter.")),x.compareFunction&&(i.texParameteri(E,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(E,i.TEXTURE_COMPARE_FUNC,xt[x.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){const et=t.get("EXT_texture_filter_anisotropic");if(x.magFilter===he||x.minFilter!==xr&&x.minFilter!==ui||x.type===on&&t.has("OES_texture_float_linear")===!1||s===!1&&x.type===di&&t.has("OES_texture_half_float_linear")===!1)return;(x.anisotropy>1||n.get(x).__currentAnisotropy)&&(i.texParameterf(E,et.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(x.anisotropy,r.getMaxAnisotropy())),n.get(x).__currentAnisotropy=x.anisotropy)}}function Z(E,x){let O=!1;E.__webglInit===void 0&&(E.__webglInit=!0,x.addEventListener("dispose",B));const et=x.source;let J=m.get(et);J===void 0&&(J={},m.set(et,J));const nt=X(x);if(nt!==E.__cacheKey){J[nt]===void 0&&(J[nt]={texture:i.createTexture(),usedTimes:0},a.memory.textures++,O=!0),J[nt].usedTimes++;const pt=J[E.__cacheKey];pt!==void 0&&(J[E.__cacheKey].usedTimes--,pt.usedTimes===0&&L(x)),E.__cacheKey=nt,E.__webglTexture=J[nt].texture}return O}function _t(E,x,O){let et=i.TEXTURE_2D;(x.isDataArrayTexture||x.isCompressedArrayTexture)&&(et=i.TEXTURE_2D_ARRAY),x.isData3DTexture&&(et=i.TEXTURE_3D);const J=Z(E,x),nt=x.source;e.bindTexture(et,E.__webglTexture,i.TEXTURE0+O);const pt=n.get(nt);if(nt.version!==pt.__version||J===!0){e.activeTexture(i.TEXTURE0+O);const ot=Gt.getPrimaries(Gt.workingColorSpace),ut=x.colorSpace===Ae?null:Gt.getPrimaries(x.colorSpace),Mt=x.colorSpace===Ae||ot===ut?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,x.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,x.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,x.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Mt);const zt=S(x)&&M(x.image)===!1;let tt=g(x.image,zt,!1,d);tt=de(x,tt);const Vt=M(tt)||s,Ct=o.convert(x.format,x.colorSpace);let St=o.convert(x.type),bt=U(x.internalFormat,Ct,St,x.colorSpace,x.isVideoTexture);F(et,x,Vt);let A;const rt=x.mipmaps,it=s&&x.isVideoTexture!==!0,ht=pt.__version===void 0||J===!0,lt=b(x,tt,Vt);if(x.isDepthTexture)bt=i.DEPTH_COMPONENT,s?x.type===on?bt=i.DEPTH_COMPONENT32F:x.type===rn?bt=i.DEPTH_COMPONENT24:x.type===dn?bt=i.DEPTH24_STENCIL8:bt=i.DEPTH_COMPONENT16:x.type===on&&console.error("WebGLRenderer: Floating point depth texture requires WebGL2."),x.format===hn&&bt===i.DEPTH_COMPONENT&&x.type!==br&&x.type!==rn&&(console.warn("THREE.WebGLRenderer: Use UnsignedShortType or UnsignedIntType for DepthFormat DepthTexture."),x.type=rn,St=o.convert(x.type)),x.format===In&&bt===i.DEPTH_COMPONENT&&(bt=i.DEPTH_STENCIL,x.type!==dn&&(console.warn("THREE.WebGLRenderer: Use UnsignedInt248Type for DepthStencilFormat DepthTexture."),x.type=dn,St=o.convert(x.type))),ht&&(it?e.texStorage2D(i.TEXTURE_2D,1,bt,tt.width,tt.height):e.texImage2D(i.TEXTURE_2D,0,bt,tt.width,tt.height,0,Ct,St,null));else if(x.isDataTexture)if(rt.length>0&&Vt){it&&ht&&e.texStorage2D(i.TEXTURE_2D,lt,bt,rt[0].width,rt[0].height);for(let j=0,mt=rt.length;j<mt;j++)A=rt[j],it?e.texSubImage2D(i.TEXTURE_2D,j,0,0,A.width,A.height,Ct,St,A.data):e.texImage2D(i.TEXTURE_2D,j,bt,A.width,A.height,0,Ct,St,A.data);x.generateMipmaps=!1}else it?(ht&&e.texStorage2D(i.TEXTURE_2D,lt,bt,tt.width,tt.height),e.texSubImage2D(i.TEXTURE_2D,0,0,0,tt.width,tt.height,Ct,St,tt.data)):e.texImage2D(i.TEXTURE_2D,0,bt,tt.width,tt.height,0,Ct,St,tt.data);else if(x.isCompressedTexture)if(x.isCompressedArrayTexture){it&&ht&&e.texStorage3D(i.TEXTURE_2D_ARRAY,lt,bt,rt[0].width,rt[0].height,tt.depth);for(let j=0,mt=rt.length;j<mt;j++)A=rt[j],x.format!==De?Ct!==null?it?e.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,j,0,0,0,A.width,A.height,tt.depth,Ct,A.data,0,0):e.compressedTexImage3D(i.TEXTURE_2D_ARRAY,j,bt,A.width,A.height,tt.depth,0,A.data,0,0):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):it?e.texSubImage3D(i.TEXTURE_2D_ARRAY,j,0,0,0,A.width,A.height,tt.depth,Ct,St,A.data):e.texImage3D(i.TEXTURE_2D_ARRAY,j,bt,A.width,A.height,tt.depth,0,Ct,St,A.data)}else{it&&ht&&e.texStorage2D(i.TEXTURE_2D,lt,bt,rt[0].width,rt[0].height);for(let j=0,mt=rt.length;j<mt;j++)A=rt[j],x.format!==De?Ct!==null?it?e.compressedTexSubImage2D(i.TEXTURE_2D,j,0,0,A.width,A.height,Ct,A.data):e.compressedTexImage2D(i.TEXTURE_2D,j,bt,A.width,A.height,0,A.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):it?e.texSubImage2D(i.TEXTURE_2D,j,0,0,A.width,A.height,Ct,St,A.data):e.texImage2D(i.TEXTURE_2D,j,bt,A.width,A.height,0,Ct,St,A.data)}else if(x.isDataArrayTexture)it?(ht&&e.texStorage3D(i.TEXTURE_2D_ARRAY,lt,bt,tt.width,tt.height,tt.depth),e.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,tt.width,tt.height,tt.depth,Ct,St,tt.data)):e.texImage3D(i.TEXTURE_2D_ARRAY,0,bt,tt.width,tt.height,tt.depth,0,Ct,St,tt.data);else if(x.isData3DTexture)it?(ht&&e.texStorage3D(i.TEXTURE_3D,lt,bt,tt.width,tt.height,tt.depth),e.texSubImage3D(i.TEXTURE_3D,0,0,0,0,tt.width,tt.height,tt.depth,Ct,St,tt.data)):e.texImage3D(i.TEXTURE_3D,0,bt,tt.width,tt.height,tt.depth,0,Ct,St,tt.data);else if(x.isFramebufferTexture){if(ht)if(it)e.texStorage2D(i.TEXTURE_2D,lt,bt,tt.width,tt.height);else{let j=tt.width,mt=tt.height;for(let kt=0;kt<lt;kt++)e.texImage2D(i.TEXTURE_2D,kt,bt,j,mt,0,Ct,St,null),j>>=1,mt>>=1}}else if(rt.length>0&&Vt){it&&ht&&e.texStorage2D(i.TEXTURE_2D,lt,bt,rt[0].width,rt[0].height);for(let j=0,mt=rt.length;j<mt;j++)A=rt[j],it?e.texSubImage2D(i.TEXTURE_2D,j,0,0,Ct,St,A):e.texImage2D(i.TEXTURE_2D,j,bt,Ct,St,A);x.generateMipmaps=!1}else it?(ht&&e.texStorage2D(i.TEXTURE_2D,lt,bt,tt.width,tt.height),e.texSubImage2D(i.TEXTURE_2D,0,0,0,Ct,St,tt)):e.texImage2D(i.TEXTURE_2D,0,bt,Ct,St,tt);R(x,Vt)&&C(et),pt.__version=nt.version,x.onUpdate&&x.onUpdate(x)}E.__version=x.version}function Ht(E,x,O){if(x.image.length!==6)return;const et=Z(E,x),J=x.source;e.bindTexture(i.TEXTURE_CUBE_MAP,E.__webglTexture,i.TEXTURE0+O);const nt=n.get(J);if(J.version!==nt.__version||et===!0){e.activeTexture(i.TEXTURE0+O);const pt=Gt.getPrimaries(Gt.workingColorSpace),ot=x.colorSpace===Ae?null:Gt.getPrimaries(x.colorSpace),ut=x.colorSpace===Ae||pt===ot?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,x.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,x.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,x.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,ut);const Mt=x.isCompressedTexture||x.image[0].isCompressedTexture,zt=x.image[0]&&x.image[0].isDataTexture,tt=[];for(let j=0;j<6;j++)!Mt&&!zt?tt[j]=g(x.image[j],!1,!0,c):tt[j]=zt?x.image[j].image:x.image[j],tt[j]=de(x,tt[j]);const Vt=tt[0],Ct=M(Vt)||s,St=o.convert(x.format,x.colorSpace),bt=o.convert(x.type),A=U(x.internalFormat,St,bt,x.colorSpace),rt=s&&x.isVideoTexture!==!0,it=nt.__version===void 0||et===!0;let ht=b(x,Vt,Ct);F(i.TEXTURE_CUBE_MAP,x,Ct);let lt;if(Mt){rt&&it&&e.texStorage2D(i.TEXTURE_CUBE_MAP,ht,A,Vt.width,Vt.height);for(let j=0;j<6;j++){lt=tt[j].mipmaps;for(let mt=0;mt<lt.length;mt++){const kt=lt[mt];x.format!==De?St!==null?rt?e.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,mt,0,0,kt.width,kt.height,St,kt.data):e.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,mt,A,kt.width,kt.height,0,kt.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):rt?e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,mt,0,0,kt.width,kt.height,St,bt,kt.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,mt,A,kt.width,kt.height,0,St,bt,kt.data)}}}else{lt=x.mipmaps,rt&&it&&(lt.length>0&&ht++,e.texStorage2D(i.TEXTURE_CUBE_MAP,ht,A,tt[0].width,tt[0].height));for(let j=0;j<6;j++)if(zt){rt?e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,0,0,tt[j].width,tt[j].height,St,bt,tt[j].data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,A,tt[j].width,tt[j].height,0,St,bt,tt[j].data);for(let mt=0;mt<lt.length;mt++){const ge=lt[mt].image[j].image;rt?e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,mt+1,0,0,ge.width,ge.height,St,bt,ge.data):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,mt+1,A,ge.width,ge.height,0,St,bt,ge.data)}}else{rt?e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,0,0,St,bt,tt[j]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,A,St,bt,tt[j]);for(let mt=0;mt<lt.length;mt++){const kt=lt[mt];rt?e.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,mt+1,0,0,St,bt,kt.image[j]):e.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,mt+1,A,St,bt,kt.image[j])}}}R(x,Ct)&&C(i.TEXTURE_CUBE_MAP),nt.__version=J.version,x.onUpdate&&x.onUpdate(x)}E.__version=x.version}function wt(E,x,O,et,J,nt){const pt=o.convert(O.format,O.colorSpace),ot=o.convert(O.type),ut=U(O.internalFormat,pt,ot,O.colorSpace);if(!n.get(x).__hasExternalTextures){const zt=Math.max(1,x.width>>nt),tt=Math.max(1,x.height>>nt);J===i.TEXTURE_3D||J===i.TEXTURE_2D_ARRAY?e.texImage3D(J,nt,ut,zt,tt,x.depth,0,pt,ot,null):e.texImage2D(J,nt,ut,zt,tt,0,pt,ot,null)}e.bindFramebuffer(i.FRAMEBUFFER,E),Wt(x)?h.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,et,J,n.get(O).__webglTexture,0,It(x)):(J===i.TEXTURE_2D||J>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&J<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,et,J,n.get(O).__webglTexture,nt),e.bindFramebuffer(i.FRAMEBUFFER,null)}function D(E,x,O){if(i.bindRenderbuffer(i.RENDERBUFFER,E),x.depthBuffer&&!x.stencilBuffer){let et=s===!0?i.DEPTH_COMPONENT24:i.DEPTH_COMPONENT16;if(O||Wt(x)){const J=x.depthTexture;J&&J.isDepthTexture&&(J.type===on?et=i.DEPTH_COMPONENT32F:J.type===rn&&(et=i.DEPTH_COMPONENT24));const nt=It(x);Wt(x)?h.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,nt,et,x.width,x.height):i.renderbufferStorageMultisample(i.RENDERBUFFER,nt,et,x.width,x.height)}else i.renderbufferStorage(i.RENDERBUFFER,et,x.width,x.height);i.framebufferRenderbuffer(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.RENDERBUFFER,E)}else if(x.depthBuffer&&x.stencilBuffer){const et=It(x);O&&Wt(x)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,et,i.DEPTH24_STENCIL8,x.width,x.height):Wt(x)?h.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,et,i.DEPTH24_STENCIL8,x.width,x.height):i.renderbufferStorage(i.RENDERBUFFER,i.DEPTH_STENCIL,x.width,x.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.RENDERBUFFER,E)}else{const et=x.isWebGLMultipleRenderTargets===!0?x.texture:[x.texture];for(let J=0;J<et.length;J++){const nt=et[J],pt=o.convert(nt.format,nt.colorSpace),ot=o.convert(nt.type),ut=U(nt.internalFormat,pt,ot,nt.colorSpace),Mt=It(x);O&&Wt(x)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,Mt,ut,x.width,x.height):Wt(x)?h.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Mt,ut,x.width,x.height):i.renderbufferStorage(i.RENDERBUFFER,ut,x.width,x.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function ae(E,x){if(x&&x.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(e.bindFramebuffer(i.FRAMEBUFFER,E),!(x.depthTexture&&x.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!n.get(x.depthTexture).__webglTexture||x.depthTexture.image.width!==x.width||x.depthTexture.image.height!==x.height)&&(x.depthTexture.image.width=x.width,x.depthTexture.image.height=x.height,x.depthTexture.needsUpdate=!0),$(x.depthTexture,0);const et=n.get(x.depthTexture).__webglTexture,J=It(x);if(x.depthTexture.format===hn)Wt(x)?h.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,et,0,J):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,et,0);else if(x.depthTexture.format===In)Wt(x)?h.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,et,0,J):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,et,0);else throw new Error("Unknown depthTexture format")}function gt(E){const x=n.get(E),O=E.isWebGLCubeRenderTarget===!0;if(E.depthTexture&&!x.__autoAllocateDepthBuffer){if(O)throw new Error("target.depthTexture not supported in Cube render targets");ae(x.__webglFramebuffer,E)}else if(O){x.__webglDepthbuffer=[];for(let et=0;et<6;et++)e.bindFramebuffer(i.FRAMEBUFFER,x.__webglFramebuffer[et]),x.__webglDepthbuffer[et]=i.createRenderbuffer(),D(x.__webglDepthbuffer[et],E,!1)}else e.bindFramebuffer(i.FRAMEBUFFER,x.__webglFramebuffer),x.__webglDepthbuffer=i.createRenderbuffer(),D(x.__webglDepthbuffer,E,!1);e.bindFramebuffer(i.FRAMEBUFFER,null)}function Pt(E,x,O){const et=n.get(E);x!==void 0&&wt(et.__webglFramebuffer,E,E.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),O!==void 0&&gt(E)}function Rt(E){const x=E.texture,O=n.get(E),et=n.get(x);E.addEventListener("dispose",q),E.isWebGLMultipleRenderTargets!==!0&&(et.__webglTexture===void 0&&(et.__webglTexture=i.createTexture()),et.__version=x.version,a.memory.textures++);const J=E.isWebGLCubeRenderTarget===!0,nt=E.isWebGLMultipleRenderTargets===!0,pt=M(E)||s;if(J){O.__webglFramebuffer=[];for(let ot=0;ot<6;ot++)if(s&&x.mipmaps&&x.mipmaps.length>0){O.__webglFramebuffer[ot]=[];for(let ut=0;ut<x.mipmaps.length;ut++)O.__webglFramebuffer[ot][ut]=i.createFramebuffer()}else O.__webglFramebuffer[ot]=i.createFramebuffer()}else{if(s&&x.mipmaps&&x.mipmaps.length>0){O.__webglFramebuffer=[];for(let ot=0;ot<x.mipmaps.length;ot++)O.__webglFramebuffer[ot]=i.createFramebuffer()}else O.__webglFramebuffer=i.createFramebuffer();if(nt)if(r.drawBuffers){const ot=E.texture;for(let ut=0,Mt=ot.length;ut<Mt;ut++){const zt=n.get(ot[ut]);zt.__webglTexture===void 0&&(zt.__webglTexture=i.createTexture(),a.memory.textures++)}}else console.warn("THREE.WebGLRenderer: WebGLMultipleRenderTargets can only be used with WebGL2 or WEBGL_draw_buffers extension.");if(s&&E.samples>0&&Wt(E)===!1){const ot=nt?x:[x];O.__webglMultisampledFramebuffer=i.createFramebuffer(),O.__webglColorRenderbuffer=[],e.bindFramebuffer(i.FRAMEBUFFER,O.__webglMultisampledFramebuffer);for(let ut=0;ut<ot.length;ut++){const Mt=ot[ut];O.__webglColorRenderbuffer[ut]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,O.__webglColorRenderbuffer[ut]);const zt=o.convert(Mt.format,Mt.colorSpace),tt=o.convert(Mt.type),Vt=U(Mt.internalFormat,zt,tt,Mt.colorSpace,E.isXRRenderTarget===!0),Ct=It(E);i.renderbufferStorageMultisample(i.RENDERBUFFER,Ct,Vt,E.width,E.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ut,i.RENDERBUFFER,O.__webglColorRenderbuffer[ut])}i.bindRenderbuffer(i.RENDERBUFFER,null),E.depthBuffer&&(O.__webglDepthRenderbuffer=i.createRenderbuffer(),D(O.__webglDepthRenderbuffer,E,!0)),e.bindFramebuffer(i.FRAMEBUFFER,null)}}if(J){e.bindTexture(i.TEXTURE_CUBE_MAP,et.__webglTexture),F(i.TEXTURE_CUBE_MAP,x,pt);for(let ot=0;ot<6;ot++)if(s&&x.mipmaps&&x.mipmaps.length>0)for(let ut=0;ut<x.mipmaps.length;ut++)wt(O.__webglFramebuffer[ot][ut],E,x,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+ot,ut);else wt(O.__webglFramebuffer[ot],E,x,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+ot,0);R(x,pt)&&C(i.TEXTURE_CUBE_MAP),e.unbindTexture()}else if(nt){const ot=E.texture;for(let ut=0,Mt=ot.length;ut<Mt;ut++){const zt=ot[ut],tt=n.get(zt);e.bindTexture(i.TEXTURE_2D,tt.__webglTexture),F(i.TEXTURE_2D,zt,pt),wt(O.__webglFramebuffer,E,zt,i.COLOR_ATTACHMENT0+ut,i.TEXTURE_2D,0),R(zt,pt)&&C(i.TEXTURE_2D)}e.unbindTexture()}else{let ot=i.TEXTURE_2D;if((E.isWebGL3DRenderTarget||E.isWebGLArrayRenderTarget)&&(s?ot=E.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY:console.error("THREE.WebGLTextures: THREE.Data3DTexture and THREE.DataArrayTexture only supported with WebGL2.")),e.bindTexture(ot,et.__webglTexture),F(ot,x,pt),s&&x.mipmaps&&x.mipmaps.length>0)for(let ut=0;ut<x.mipmaps.length;ut++)wt(O.__webglFramebuffer[ut],E,x,i.COLOR_ATTACHMENT0,ot,ut);else wt(O.__webglFramebuffer,E,x,i.COLOR_ATTACHMENT0,ot,0);R(x,pt)&&C(ot),e.unbindTexture()}E.depthBuffer&&gt(E)}function Yt(E){const x=M(E)||s,O=E.isWebGLMultipleRenderTargets===!0?E.texture:[E.texture];for(let et=0,J=O.length;et<J;et++){const nt=O[et];if(R(nt,x)){const pt=E.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:i.TEXTURE_2D,ot=n.get(nt).__webglTexture;e.bindTexture(pt,ot),C(pt),e.unbindTexture()}}}function Ot(E){if(s&&E.samples>0&&Wt(E)===!1){const x=E.isWebGLMultipleRenderTargets?E.texture:[E.texture],O=E.width,et=E.height;let J=i.COLOR_BUFFER_BIT;const nt=[],pt=E.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ot=n.get(E),ut=E.isWebGLMultipleRenderTargets===!0;if(ut)for(let Mt=0;Mt<x.length;Mt++)e.bindFramebuffer(i.FRAMEBUFFER,ot.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Mt,i.RENDERBUFFER,null),e.bindFramebuffer(i.FRAMEBUFFER,ot.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+Mt,i.TEXTURE_2D,null,0);e.bindFramebuffer(i.READ_FRAMEBUFFER,ot.__webglMultisampledFramebuffer),e.bindFramebuffer(i.DRAW_FRAMEBUFFER,ot.__webglFramebuffer);for(let Mt=0;Mt<x.length;Mt++){nt.push(i.COLOR_ATTACHMENT0+Mt),E.depthBuffer&&nt.push(pt);const zt=ot.__ignoreDepthValues!==void 0?ot.__ignoreDepthValues:!1;if(zt===!1&&(E.depthBuffer&&(J|=i.DEPTH_BUFFER_BIT),E.stencilBuffer&&(J|=i.STENCIL_BUFFER_BIT)),ut&&i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,ot.__webglColorRenderbuffer[Mt]),zt===!0&&(i.invalidateFramebuffer(i.READ_FRAMEBUFFER,[pt]),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[pt])),ut){const tt=n.get(x[Mt]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,tt,0)}i.blitFramebuffer(0,0,O,et,0,0,O,et,J,i.NEAREST),p&&i.invalidateFramebuffer(i.READ_FRAMEBUFFER,nt)}if(e.bindFramebuffer(i.READ_FRAMEBUFFER,null),e.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),ut)for(let Mt=0;Mt<x.length;Mt++){e.bindFramebuffer(i.FRAMEBUFFER,ot.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+Mt,i.RENDERBUFFER,ot.__webglColorRenderbuffer[Mt]);const zt=n.get(x[Mt]).__webglTexture;e.bindFramebuffer(i.FRAMEBUFFER,ot.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+Mt,i.TEXTURE_2D,zt,0)}e.bindFramebuffer(i.DRAW_FRAMEBUFFER,ot.__webglMultisampledFramebuffer)}}function It(E){return Math.min(f,E.samples)}function Wt(E){const x=n.get(E);return s&&E.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&x.__useRenderToTexture!==!1}function le(E){const x=a.render.frame;v.get(E)!==x&&(v.set(E,x),E.update())}function de(E,x){const O=E.colorSpace,et=E.format,J=E.type;return E.isCompressedTexture===!0||E.isVideoTexture===!0||E.format===Rr||O!==Ve&&O!==Ae&&(Gt.getTransfer(O)===Xt?s===!1?t.has("EXT_sRGB")===!0&&et===De?(E.format=Rr,E.minFilter=Te,E.generateMipmaps=!1):x=bs.sRGBToLinear(x):(et!==De||J!==nn)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",O)),x}this.allocateTextureUnit=Q,this.resetTextureUnits=W,this.setTexture2D=$,this.setTexture2DArray=P,this.setTexture3D=V,this.setTextureCube=at,this.rebindTextures=Pt,this.setupRenderTarget=Rt,this.updateRenderTargetMipmap=Yt,this.updateMultisampleRenderTarget=Ot,this.setupDepthRenderbuffer=gt,this.setupFrameBufferTexture=wt,this.useMultisampledRTT=Wt}function If(i,t,e){const n=e.isWebGL2;function r(o,a=Ae){let s;const l=Gt.getTransfer(a);if(o===nn)return i.UNSIGNED_BYTE;if(o===Uo)return i.UNSIGNED_SHORT_4_4_4_4;if(o===Io)return i.UNSIGNED_SHORT_5_5_5_1;if(o===Ol)return i.BYTE;if(o===Bl)return i.SHORT;if(o===br)return i.UNSIGNED_SHORT;if(o===Do)return i.INT;if(o===rn)return i.UNSIGNED_INT;if(o===on)return i.FLOAT;if(o===di)return n?i.HALF_FLOAT:(s=t.get("OES_texture_half_float"),s!==null?s.HALF_FLOAT_OES:null);if(o===zl)return i.ALPHA;if(o===De)return i.RGBA;if(o===Hl)return i.LUMINANCE;if(o===Gl)return i.LUMINANCE_ALPHA;if(o===hn)return i.DEPTH_COMPONENT;if(o===In)return i.DEPTH_STENCIL;if(o===Rr)return s=t.get("EXT_sRGB"),s!==null?s.SRGB_ALPHA_EXT:null;if(o===Vl)return i.RED;if(o===No)return i.RED_INTEGER;if(o===Wl)return i.RG;if(o===Fo)return i.RG_INTEGER;if(o===Oo)return i.RGBA_INTEGER;if(o===wr||o===yr||o===Mr||o===Sr)if(l===Xt)if(s=t.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(o===wr)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(o===yr)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(o===Mr)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(o===Sr)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=t.get("WEBGL_compressed_texture_s3tc"),s!==null){if(o===wr)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(o===yr)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(o===Mr)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(o===Sr)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(o===Bo||o===zo||o===Ho||o===Go)if(s=t.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(o===Bo)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(o===zo)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(o===Ho)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(o===Go)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(o===Xl)return s=t.get("WEBGL_compressed_texture_etc1"),s!==null?s.COMPRESSED_RGB_ETC1_WEBGL:null;if(o===Vo||o===Wo)if(s=t.get("WEBGL_compressed_texture_etc"),s!==null){if(o===Vo)return l===Xt?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(o===Wo)return l===Xt?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(o===Xo||o===qo||o===Yo||o===jo||o===$o||o===Zo||o===Ko||o===Jo||o===Qo||o===ts||o===es||o===ns||o===is||o===rs)if(s=t.get("WEBGL_compressed_texture_astc"),s!==null){if(o===Xo)return l===Xt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(o===qo)return l===Xt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(o===Yo)return l===Xt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(o===jo)return l===Xt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(o===$o)return l===Xt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(o===Zo)return l===Xt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(o===Ko)return l===Xt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(o===Jo)return l===Xt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(o===Qo)return l===Xt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(o===ts)return l===Xt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(o===es)return l===Xt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(o===ns)return l===Xt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(o===is)return l===Xt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(o===rs)return l===Xt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(o===Er||o===os||o===ss)if(s=t.get("EXT_texture_compression_bptc"),s!==null){if(o===Er)return l===Xt?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(o===os)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(o===ss)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(o===ql||o===as||o===ls||o===cs)if(s=t.get("EXT_texture_compression_rgtc"),s!==null){if(o===Er)return s.COMPRESSED_RED_RGTC1_EXT;if(o===as)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(o===ls)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(o===cs)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return o===dn?n?i.UNSIGNED_INT_24_8:(s=t.get("WEBGL_depth_texture"),s!==null?s.UNSIGNED_INT_24_8_WEBGL:null):i[o]!==void 0?i[o]:null}return{convert:r}}class Nf extends ke{constructor(t=[]){super(),this.isArrayCamera=!0,this.cameras=t}}class ir extends ie{constructor(){super(),this.isGroup=!0,this.type="Group"}}const Ff={type:"move"};class eo{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new ir,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new ir,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new k,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new k),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new ir,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new k,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new k),this._grip}dispatchEvent(t){return this._targetRay!==null&&this._targetRay.dispatchEvent(t),this._grip!==null&&this._grip.dispatchEvent(t),this._hand!==null&&this._hand.dispatchEvent(t),this}connect(t){if(t&&t.hand){const e=this._hand;if(e)for(const n of t.hand.values())this._getHandJoint(e,n)}return this.dispatchEvent({type:"connected",data:t}),this}disconnect(t){return this.dispatchEvent({type:"disconnected",data:t}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(t,e,n){let r=null,o=null,a=null;const s=this._targetRay,l=this._grip,c=this._hand;if(t&&e.session.visibilityState!=="visible-blurred"){if(c&&t.hand){a=!0;for(const _ of t.hand.values()){const m=e.getJointPose(_,n),u=this._getHandJoint(c,_);m!==null&&(u.matrix.fromArray(m.transform.matrix),u.matrix.decompose(u.position,u.rotation,u.scale),u.matrixWorldNeedsUpdate=!0,u.jointRadius=m.radius),u.visible=m!==null}const d=c.joints["index-finger-tip"],f=c.joints["thumb-tip"],h=d.position.distanceTo(f.position),p=.02,v=.005;c.inputState.pinching&&h>p+v?(c.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:t.handedness,target:this})):!c.inputState.pinching&&h<=p-v&&(c.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:t.handedness,target:this}))}else l!==null&&t.gripSpace&&(o=e.getPose(t.gripSpace,n),o!==null&&(l.matrix.fromArray(o.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,o.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(o.linearVelocity)):l.hasLinearVelocity=!1,o.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(o.angularVelocity)):l.hasAngularVelocity=!1));s!==null&&(r=e.getPose(t.targetRaySpace,n),r===null&&o!==null&&(r=o),r!==null&&(s.matrix.fromArray(r.transform.matrix),s.matrix.decompose(s.position,s.rotation,s.scale),s.matrixWorldNeedsUpdate=!0,r.linearVelocity?(s.hasLinearVelocity=!0,s.linearVelocity.copy(r.linearVelocity)):s.hasLinearVelocity=!1,r.angularVelocity?(s.hasAngularVelocity=!0,s.angularVelocity.copy(r.angularVelocity)):s.hasAngularVelocity=!1,this.dispatchEvent(Ff)))}return s!==null&&(s.visible=r!==null),l!==null&&(l.visible=o!==null),c!==null&&(c.visible=a!==null),this}_getHandJoint(t,e){if(t.joints[e.jointName]===void 0){const n=new ir;n.matrixAutoUpdate=!1,n.visible=!1,t.joints[e.jointName]=n,t.add(n)}return t.joints[e.jointName]}}class Of extends we{constructor(t,e,n,r,o,a,s,l,c,d){if(d=d!==void 0?d:hn,d!==hn&&d!==In)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");n===void 0&&d===hn&&(n=rn),n===void 0&&d===In&&(n=dn),super(null,r,o,a,s,l,d,n,c),this.isDepthTexture=!0,this.image={width:t,height:e},this.magFilter=s!==void 0?s:he,this.minFilter=l!==void 0?l:he,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(t){return super.copy(t),this.compareFunction=t.compareFunction,this}toJSON(t){const e=super.toJSON(t);return this.compareFunction!==null&&(e.compareFunction=this.compareFunction),e}}class Bf extends pn{constructor(t,e){super();const n=this;let r=null,o=1,a=null,s="local-floor",l=1,c=null,d=null,f=null,h=null,p=null,v=null;const _=e.getContextAttributes();let m=null,u=null;const w=[],g=[],M=new ke;M.layers.enable(1),M.viewport=new ne;const S=new ke;S.layers.enable(2),S.viewport=new ne;const R=[M,S],C=new Nf;C.layers.enable(1),C.layers.enable(2);let U=null,b=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(P){let V=w[P];return V===void 0&&(V=new eo,w[P]=V),V.getTargetRaySpace()},this.getControllerGrip=function(P){let V=w[P];return V===void 0&&(V=new eo,w[P]=V),V.getGripSpace()},this.getHand=function(P){let V=w[P];return V===void 0&&(V=new eo,w[P]=V),V.getHandSpace()};function T(P){const V=g.indexOf(P.inputSource);if(V===-1)return;const at=w[V];at!==void 0&&(at.update(P.inputSource,P.frame,c||a),at.dispatchEvent({type:P.type,data:P.inputSource}))}function B(){r.removeEventListener("select",T),r.removeEventListener("selectstart",T),r.removeEventListener("selectend",T),r.removeEventListener("squeeze",T),r.removeEventListener("squeezestart",T),r.removeEventListener("squeezeend",T),r.removeEventListener("end",B),r.removeEventListener("inputsourceschange",q);for(let P=0;P<w.length;P++){const V=g[P];V!==null&&(g[P]=null,w[P].disconnect(V))}U=null,b=null,t.setRenderTarget(m),p=null,h=null,f=null,r=null,u=null,$.stop(),n.isPresenting=!1,n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(P){o=P,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(P){s=P,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||a},this.setReferenceSpace=function(P){c=P},this.getBaseLayer=function(){return h!==null?h:p},this.getBinding=function(){return f},this.getFrame=function(){return v},this.getSession=function(){return r},this.setSession=async function(P){if(r=P,r!==null){if(m=t.getRenderTarget(),r.addEventListener("select",T),r.addEventListener("selectstart",T),r.addEventListener("selectend",T),r.addEventListener("squeeze",T),r.addEventListener("squeezestart",T),r.addEventListener("squeezeend",T),r.addEventListener("end",B),r.addEventListener("inputsourceschange",q),_.xrCompatible!==!0&&await e.makeXRCompatible(),r.renderState.layers===void 0||t.capabilities.isWebGL2===!1){const V={antialias:r.renderState.layers===void 0?_.antialias:!0,alpha:!0,depth:_.depth,stencil:_.stencil,framebufferScaleFactor:o};p=new XRWebGLLayer(r,e,V),r.updateRenderState({baseLayer:p}),u=new mn(p.framebufferWidth,p.framebufferHeight,{format:De,type:nn,colorSpace:t.outputColorSpace,stencilBuffer:_.stencil})}else{let V=null,at=null,ct=null;_.depth&&(ct=_.stencil?e.DEPTH24_STENCIL8:e.DEPTH_COMPONENT24,V=_.stencil?In:hn,at=_.stencil?dn:rn);const dt={colorFormat:e.RGBA8,depthFormat:ct,scaleFactor:o};f=new XRWebGLBinding(r,e),h=f.createProjectionLayer(dt),r.updateRenderState({layers:[h]}),u=new mn(h.textureWidth,h.textureHeight,{format:De,type:nn,depthTexture:new Of(h.textureWidth,h.textureHeight,at,void 0,void 0,void 0,void 0,void 0,void 0,V),stencilBuffer:_.stencil,colorSpace:t.outputColorSpace,samples:_.antialias?4:0});const xt=t.properties.get(u);xt.__ignoreDepthValues=h.ignoreDepthValues}u.isXRRenderTarget=!0,this.setFoveation(l),c=null,a=await r.requestReferenceSpace(s),$.setContext(r),$.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode};function q(P){for(let V=0;V<P.removed.length;V++){const at=P.removed[V],ct=g.indexOf(at);ct>=0&&(g[ct]=null,w[ct].disconnect(at))}for(let V=0;V<P.added.length;V++){const at=P.added[V];let ct=g.indexOf(at);if(ct===-1){for(let xt=0;xt<w.length;xt++)if(xt>=g.length){g.push(at),ct=xt;break}else if(g[xt]===null){g[xt]=at,ct=xt;break}if(ct===-1)break}const dt=w[ct];dt&&dt.connect(at)}}const K=new k,L=new k;function G(P,V,at){K.setFromMatrixPosition(V.matrixWorld),L.setFromMatrixPosition(at.matrixWorld);const ct=K.distanceTo(L),dt=V.projectionMatrix.elements,xt=at.projectionMatrix.elements,F=dt[14]/(dt[10]-1),Z=dt[14]/(dt[10]+1),_t=(dt[9]+1)/dt[5],Ht=(dt[9]-1)/dt[5],wt=(dt[8]-1)/dt[0],D=(xt[8]+1)/xt[0],ae=F*wt,gt=F*D,Pt=ct/(-wt+D),Rt=Pt*-wt;V.matrixWorld.decompose(P.position,P.quaternion,P.scale),P.translateX(Rt),P.translateZ(Pt),P.matrixWorld.compose(P.position,P.quaternion,P.scale),P.matrixWorldInverse.copy(P.matrixWorld).invert();const Yt=F+Pt,Ot=Z+Pt,It=ae-Rt,Wt=gt+(ct-Rt),le=_t*Z/Ot*Yt,de=Ht*Z/Ot*Yt;P.projectionMatrix.makePerspective(It,Wt,le,de,Yt,Ot),P.projectionMatrixInverse.copy(P.projectionMatrix).invert()}function Y(P,V){V===null?P.matrixWorld.copy(P.matrix):P.matrixWorld.multiplyMatrices(V.matrixWorld,P.matrix),P.matrixWorldInverse.copy(P.matrixWorld).invert()}this.updateCamera=function(P){if(r===null)return;C.near=S.near=M.near=P.near,C.far=S.far=M.far=P.far,(U!==C.near||b!==C.far)&&(r.updateRenderState({depthNear:C.near,depthFar:C.far}),U=C.near,b=C.far);const V=P.parent,at=C.cameras;Y(C,V);for(let ct=0;ct<at.length;ct++)Y(at[ct],V);at.length===2?G(C,M,S):C.projectionMatrix.copy(M.projectionMatrix),W(P,C,V)};function W(P,V,at){at===null?P.matrix.copy(V.matrixWorld):(P.matrix.copy(at.matrixWorld),P.matrix.invert(),P.matrix.multiply(V.matrixWorld)),P.matrix.decompose(P.position,P.quaternion,P.scale),P.updateMatrixWorld(!0),P.projectionMatrix.copy(V.projectionMatrix),P.projectionMatrixInverse.copy(V.projectionMatrixInverse),P.isPerspectiveCamera&&(P.fov=fi*2*Math.atan(1/P.projectionMatrix.elements[5]),P.zoom=1)}this.getCamera=function(){return C},this.getFoveation=function(){if(!(h===null&&p===null))return l},this.setFoveation=function(P){l=P,h!==null&&(h.fixedFoveation=P),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=P)};let Q=null;function X(P,V){if(d=V.getViewerPose(c||a),v=V,d!==null){const at=d.views;p!==null&&(t.setRenderTargetFramebuffer(u,p.framebuffer),t.setRenderTarget(u));let ct=!1;at.length!==C.cameras.length&&(C.cameras.length=0,ct=!0);for(let dt=0;dt<at.length;dt++){const xt=at[dt];let F=null;if(p!==null)F=p.getViewport(xt);else{const _t=f.getViewSubImage(h,xt);F=_t.viewport,dt===0&&(t.setRenderTargetTextures(u,_t.colorTexture,h.ignoreDepthValues?void 0:_t.depthStencilTexture),t.setRenderTarget(u))}let Z=R[dt];Z===void 0&&(Z=new ke,Z.layers.enable(dt),Z.viewport=new ne,R[dt]=Z),Z.matrix.fromArray(xt.transform.matrix),Z.matrix.decompose(Z.position,Z.quaternion,Z.scale),Z.projectionMatrix.fromArray(xt.projectionMatrix),Z.projectionMatrixInverse.copy(Z.projectionMatrix).invert(),Z.viewport.set(F.x,F.y,F.width,F.height),dt===0&&(C.matrix.copy(Z.matrix),C.matrix.decompose(C.position,C.quaternion,C.scale)),ct===!0&&C.cameras.push(Z)}}for(let at=0;at<w.length;at++){const ct=g[at],dt=w[at];ct!==null&&dt!==void 0&&dt.update(ct,V,c||a)}Q&&Q(P,V),V.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:V}),v=null}const $=new Xs;$.setAnimationLoop(X),this.setAnimationLoop=function(P){Q=P},this.dispose=function(){}}}function zf(i,t){function e(m,u){m.matrixAutoUpdate===!0&&m.updateMatrix(),u.value.copy(m.matrix)}function n(m,u){u.color.getRGB(m.fogColor.value,Gs(i)),u.isFog?(m.fogNear.value=u.near,m.fogFar.value=u.far):u.isFogExp2&&(m.fogDensity.value=u.density)}function r(m,u,w,g,M){u.isMeshBasicMaterial||u.isMeshLambertMaterial?o(m,u):u.isMeshToonMaterial?(o(m,u),f(m,u)):u.isMeshPhongMaterial?(o(m,u),d(m,u)):u.isMeshStandardMaterial?(o(m,u),h(m,u),u.isMeshPhysicalMaterial&&p(m,u,M)):u.isMeshMatcapMaterial?(o(m,u),v(m,u)):u.isMeshDepthMaterial?o(m,u):u.isMeshDistanceMaterial?(o(m,u),_(m,u)):u.isMeshNormalMaterial?o(m,u):u.isLineBasicMaterial?(a(m,u),u.isLineDashedMaterial&&s(m,u)):u.isPointsMaterial?l(m,u,w,g):u.isSpriteMaterial?c(m,u):u.isShadowMaterial?(m.color.value.copy(u.color),m.opacity.value=u.opacity):u.isShaderMaterial&&(u.uniformsNeedUpdate=!1)}function o(m,u){m.opacity.value=u.opacity,u.color&&m.diffuse.value.copy(u.color),u.emissive&&m.emissive.value.copy(u.emissive).multiplyScalar(u.emissiveIntensity),u.map&&(m.map.value=u.map,e(u.map,m.mapTransform)),u.alphaMap&&(m.alphaMap.value=u.alphaMap,e(u.alphaMap,m.alphaMapTransform)),u.bumpMap&&(m.bumpMap.value=u.bumpMap,e(u.bumpMap,m.bumpMapTransform),m.bumpScale.value=u.bumpScale,u.side===be&&(m.bumpScale.value*=-1)),u.normalMap&&(m.normalMap.value=u.normalMap,e(u.normalMap,m.normalMapTransform),m.normalScale.value.copy(u.normalScale),u.side===be&&m.normalScale.value.negate()),u.displacementMap&&(m.displacementMap.value=u.displacementMap,e(u.displacementMap,m.displacementMapTransform),m.displacementScale.value=u.displacementScale,m.displacementBias.value=u.displacementBias),u.emissiveMap&&(m.emissiveMap.value=u.emissiveMap,e(u.emissiveMap,m.emissiveMapTransform)),u.specularMap&&(m.specularMap.value=u.specularMap,e(u.specularMap,m.specularMapTransform)),u.alphaTest>0&&(m.alphaTest.value=u.alphaTest);const w=t.get(u).envMap;if(w&&(m.envMap.value=w,m.flipEnvMap.value=w.isCubeTexture&&w.isRenderTargetTexture===!1?-1:1,m.reflectivity.value=u.reflectivity,m.ior.value=u.ior,m.refractionRatio.value=u.refractionRatio),u.lightMap){m.lightMap.value=u.lightMap;const g=i._useLegacyLights===!0?Math.PI:1;m.lightMapIntensity.value=u.lightMapIntensity*g,e(u.lightMap,m.lightMapTransform)}u.aoMap&&(m.aoMap.value=u.aoMap,m.aoMapIntensity.value=u.aoMapIntensity,e(u.aoMap,m.aoMapTransform))}function a(m,u){m.diffuse.value.copy(u.color),m.opacity.value=u.opacity,u.map&&(m.map.value=u.map,e(u.map,m.mapTransform))}function s(m,u){m.dashSize.value=u.dashSize,m.totalSize.value=u.dashSize+u.gapSize,m.scale.value=u.scale}function l(m,u,w,g){m.diffuse.value.copy(u.color),m.opacity.value=u.opacity,m.size.value=u.size*w,m.scale.value=g*.5,u.map&&(m.map.value=u.map,e(u.map,m.uvTransform)),u.alphaMap&&(m.alphaMap.value=u.alphaMap,e(u.alphaMap,m.alphaMapTransform)),u.alphaTest>0&&(m.alphaTest.value=u.alphaTest)}function c(m,u){m.diffuse.value.copy(u.color),m.opacity.value=u.opacity,m.rotation.value=u.rotation,u.map&&(m.map.value=u.map,e(u.map,m.mapTransform)),u.alphaMap&&(m.alphaMap.value=u.alphaMap,e(u.alphaMap,m.alphaMapTransform)),u.alphaTest>0&&(m.alphaTest.value=u.alphaTest)}function d(m,u){m.specular.value.copy(u.specular),m.shininess.value=Math.max(u.shininess,1e-4)}function f(m,u){u.gradientMap&&(m.gradientMap.value=u.gradientMap)}function h(m,u){m.metalness.value=u.metalness,u.metalnessMap&&(m.metalnessMap.value=u.metalnessMap,e(u.metalnessMap,m.metalnessMapTransform)),m.roughness.value=u.roughness,u.roughnessMap&&(m.roughnessMap.value=u.roughnessMap,e(u.roughnessMap,m.roughnessMapTransform)),t.get(u).envMap&&(m.envMapIntensity.value=u.envMapIntensity)}function p(m,u,w){m.ior.value=u.ior,u.sheen>0&&(m.sheenColor.value.copy(u.sheenColor).multiplyScalar(u.sheen),m.sheenRoughness.value=u.sheenRoughness,u.sheenColorMap&&(m.sheenColorMap.value=u.sheenColorMap,e(u.sheenColorMap,m.sheenColorMapTransform)),u.sheenRoughnessMap&&(m.sheenRoughnessMap.value=u.sheenRoughnessMap,e(u.sheenRoughnessMap,m.sheenRoughnessMapTransform))),u.clearcoat>0&&(m.clearcoat.value=u.clearcoat,m.clearcoatRoughness.value=u.clearcoatRoughness,u.clearcoatMap&&(m.clearcoatMap.value=u.clearcoatMap,e(u.clearcoatMap,m.clearcoatMapTransform)),u.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=u.clearcoatRoughnessMap,e(u.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),u.clearcoatNormalMap&&(m.clearcoatNormalMap.value=u.clearcoatNormalMap,e(u.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(u.clearcoatNormalScale),u.side===be&&m.clearcoatNormalScale.value.negate())),u.iridescence>0&&(m.iridescence.value=u.iridescence,m.iridescenceIOR.value=u.iridescenceIOR,m.iridescenceThicknessMinimum.value=u.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=u.iridescenceThicknessRange[1],u.iridescenceMap&&(m.iridescenceMap.value=u.iridescenceMap,e(u.iridescenceMap,m.iridescenceMapTransform)),u.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=u.iridescenceThicknessMap,e(u.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),u.transmission>0&&(m.transmission.value=u.transmission,m.transmissionSamplerMap.value=w.texture,m.transmissionSamplerSize.value.set(w.width,w.height),u.transmissionMap&&(m.transmissionMap.value=u.transmissionMap,e(u.transmissionMap,m.transmissionMapTransform)),m.thickness.value=u.thickness,u.thicknessMap&&(m.thicknessMap.value=u.thicknessMap,e(u.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=u.attenuationDistance,m.attenuationColor.value.copy(u.attenuationColor)),u.anisotropy>0&&(m.anisotropyVector.value.set(u.anisotropy*Math.cos(u.anisotropyRotation),u.anisotropy*Math.sin(u.anisotropyRotation)),u.anisotropyMap&&(m.anisotropyMap.value=u.anisotropyMap,e(u.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=u.specularIntensity,m.specularColor.value.copy(u.specularColor),u.specularColorMap&&(m.specularColorMap.value=u.specularColorMap,e(u.specularColorMap,m.specularColorMapTransform)),u.specularIntensityMap&&(m.specularIntensityMap.value=u.specularIntensityMap,e(u.specularIntensityMap,m.specularIntensityMapTransform))}function v(m,u){u.matcap&&(m.matcap.value=u.matcap)}function _(m,u){const w=t.get(u).light;m.referencePosition.value.setFromMatrixPosition(w.matrixWorld),m.nearDistance.value=w.shadow.camera.near,m.farDistance.value=w.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:r}}function Hf(i,t,e,n){let r={},o={},a=[];const s=e.isWebGL2?i.getParameter(i.MAX_UNIFORM_BUFFER_BINDINGS):0;function l(w,g){const M=g.program;n.uniformBlockBinding(w,M)}function c(w,g){let M=r[w.id];M===void 0&&(v(w),M=d(w),r[w.id]=M,w.addEventListener("dispose",m));const S=g.program;n.updateUBOMapping(w,S);const R=t.render.frame;o[w.id]!==R&&(h(w),o[w.id]=R)}function d(w){const g=f();w.__bindingPointIndex=g;const M=i.createBuffer(),S=w.__size,R=w.usage;return i.bindBuffer(i.UNIFORM_BUFFER,M),i.bufferData(i.UNIFORM_BUFFER,S,R),i.bindBuffer(i.UNIFORM_BUFFER,null),i.bindBufferBase(i.UNIFORM_BUFFER,g,M),M}function f(){for(let w=0;w<s;w++)if(a.indexOf(w)===-1)return a.push(w),w;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function h(w){const g=r[w.id],M=w.uniforms,S=w.__cache;i.bindBuffer(i.UNIFORM_BUFFER,g);for(let R=0,C=M.length;R<C;R++){const U=M[R];if(p(U,R,S)===!0){const b=U.__offset,T=Array.isArray(U.value)?U.value:[U.value];let B=0;for(let q=0;q<T.length;q++){const K=T[q],L=_(K);typeof K=="number"?(U.__data[0]=K,i.bufferSubData(i.UNIFORM_BUFFER,b+B,U.__data)):K.isMatrix3?(U.__data[0]=K.elements[0],U.__data[1]=K.elements[1],U.__data[2]=K.elements[2],U.__data[3]=K.elements[0],U.__data[4]=K.elements[3],U.__data[5]=K.elements[4],U.__data[6]=K.elements[5],U.__data[7]=K.elements[0],U.__data[8]=K.elements[6],U.__data[9]=K.elements[7],U.__data[10]=K.elements[8],U.__data[11]=K.elements[0]):(K.toArray(U.__data,B),B+=L.storage/Float32Array.BYTES_PER_ELEMENT)}i.bufferSubData(i.UNIFORM_BUFFER,b,U.__data)}}i.bindBuffer(i.UNIFORM_BUFFER,null)}function p(w,g,M){const S=w.value;if(M[g]===void 0){if(typeof S=="number")M[g]=S;else{const R=Array.isArray(S)?S:[S],C=[];for(let U=0;U<R.length;U++)C.push(R[U].clone());M[g]=C}return!0}else if(typeof S=="number"){if(M[g]!==S)return M[g]=S,!0}else{const R=Array.isArray(M[g])?M[g]:[M[g]],C=Array.isArray(S)?S:[S];for(let U=0;U<R.length;U++){const b=R[U];if(b.equals(C[U])===!1)return b.copy(C[U]),!0}}return!1}function v(w){const g=w.uniforms;let M=0;const S=16;let R=0;for(let C=0,U=g.length;C<U;C++){const b=g[C],T={boundary:0,storage:0},B=Array.isArray(b.value)?b.value:[b.value];for(let q=0,K=B.length;q<K;q++){const L=B[q],G=_(L);T.boundary+=G.boundary,T.storage+=G.storage}if(b.__data=new Float32Array(T.storage/Float32Array.BYTES_PER_ELEMENT),b.__offset=M,C>0){R=M%S;const q=S-R;R!==0&&q-T.boundary<0&&(M+=S-R,b.__offset=M)}M+=T.storage}return R=M%S,R>0&&(M+=S-R),w.__size=M,w.__cache={},this}function _(w){const g={boundary:0,storage:0};return typeof w=="number"?(g.boundary=4,g.storage=4):w.isVector2?(g.boundary=8,g.storage=8):w.isVector3||w.isColor?(g.boundary=16,g.storage=12):w.isVector4?(g.boundary=16,g.storage=16):w.isMatrix3?(g.boundary=48,g.storage=48):w.isMatrix4?(g.boundary=64,g.storage=64):w.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",w),g}function m(w){const g=w.target;g.removeEventListener("dispose",m);const M=a.indexOf(g.__bindingPointIndex);a.splice(M,1),i.deleteBuffer(r[g.id]),delete r[g.id],delete o[g.id]}function u(){for(const w in r)i.deleteBuffer(r[w]);a=[],r={},o={}}return{bind:l,update:c,dispose:u}}class xa{constructor(t={}){const{canvas:e=xc(),context:n=null,depth:r=!0,stencil:o=!0,alpha:a=!1,antialias:s=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:d="default",failIfMajorPerformanceCaveat:f=!1}=t;this.isWebGLRenderer=!0;let h;n!==null?h=n.getContextAttributes().alpha:h=a;const p=new Uint32Array(4),v=new Int32Array(4);let _=null,m=null;const u=[],w=[];this.domElement=e,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this._outputColorSpace=oe,this._useLegacyLights=!1,this.toneMapping=en,this.toneMappingExposure=1;const g=this;let M=!1,S=0,R=0,C=null,U=-1,b=null;const T=new ne,B=new ne;let q=null;const K=new Bt(0);let L=0,G=e.width,Y=e.height,W=1,Q=null,X=null;const $=new ne(0,0,G,Y),P=new ne(0,0,G,Y);let V=!1;const at=new jr;let ct=!1,dt=!1,xt=null;const F=new jt,Z=new At,_t=new k,Ht={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};function wt(){return C===null?W:1}let D=n;function ae(y,I){for(let z=0;z<y.length;z++){const N=y[z],H=e.getContext(N,I);if(H!==null)return H}return null}try{const y={alpha:!0,depth:r,stencil:o,antialias:s,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:d,failIfMajorPerformanceCaveat:f};if("setAttribute"in e&&e.setAttribute("data-engine",`three.js r${dr}`),e.addEventListener("webglcontextlost",rt,!1),e.addEventListener("webglcontextrestored",it,!1),e.addEventListener("webglcontextcreationerror",ht,!1),D===null){const I=["webgl2","webgl","experimental-webgl"];if(g.isWebGL1Renderer===!0&&I.shift(),D=ae(I,y),D===null)throw ae(I)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}typeof WebGLRenderingContext<"u"&&D instanceof WebGLRenderingContext&&console.warn("THREE.WebGLRenderer: WebGL 1 support was deprecated in r153 and will be removed in r163."),D.getShaderPrecisionFormat===void 0&&(D.getShaderPrecisionFormat=function(){return{rangeMin:1,rangeMax:1,precision:1}})}catch(y){throw console.error("THREE.WebGLRenderer: "+y.message),y}let gt,Pt,Rt,Yt,Ot,It,Wt,le,de,E,x,O,et,J,nt,pt,ot,ut,Mt,zt,tt,Vt,Ct,St;function bt(){gt=new Kd(D),Pt=new Xd(D,gt,t),gt.init(Pt),Vt=new If(D,gt,Pt),Rt=new Df(D,gt,Pt),Yt=new th(D),Ot=new xf,It=new Uf(D,gt,Rt,Ot,Pt,Vt,Yt),Wt=new Yd(g),le=new Zd(g),de=new Wc(D,Pt),Ct=new Vd(D,gt,de,Pt),E=new Jd(D,de,Yt,Ct),x=new rh(D,E,de,Yt),Mt=new ih(D,Pt,It),pt=new qd(Ot),O=new vf(g,Wt,le,gt,Pt,Ct,pt),et=new zf(g,Ot),J=new wf,nt=new Af(gt,Pt),ut=new Gd(g,Wt,le,Rt,x,h,l),ot=new Pf(g,x,Pt),St=new Hf(D,Yt,Pt,Rt),zt=new Wd(D,gt,Yt,Pt),tt=new Qd(D,gt,Yt,Pt),Yt.programs=O.programs,g.capabilities=Pt,g.extensions=gt,g.properties=Ot,g.renderLists=J,g.shadowMap=ot,g.state=Rt,g.info=Yt}bt();const A=new Bf(g,D);this.xr=A,this.getContext=function(){return D},this.getContextAttributes=function(){return D.getContextAttributes()},this.forceContextLoss=function(){const y=gt.get("WEBGL_lose_context");y&&y.loseContext()},this.forceContextRestore=function(){const y=gt.get("WEBGL_lose_context");y&&y.restoreContext()},this.getPixelRatio=function(){return W},this.setPixelRatio=function(y){y!==void 0&&(W=y,this.setSize(G,Y,!1))},this.getSize=function(y){return y.set(G,Y)},this.setSize=function(y,I,z=!0){if(A.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}G=y,Y=I,e.width=Math.floor(y*W),e.height=Math.floor(I*W),z===!0&&(e.style.width=y+"px",e.style.height=I+"px"),this.setViewport(0,0,y,I)},this.getDrawingBufferSize=function(y){return y.set(G*W,Y*W).floor()},this.setDrawingBufferSize=function(y,I,z){G=y,Y=I,W=z,e.width=Math.floor(y*z),e.height=Math.floor(I*z),this.setViewport(0,0,y,I)},this.getCurrentViewport=function(y){return y.copy(T)},this.getViewport=function(y){return y.copy($)},this.setViewport=function(y,I,z,N){y.isVector4?$.set(y.x,y.y,y.z,y.w):$.set(y,I,z,N),Rt.viewport(T.copy($).multiplyScalar(W).floor())},this.getScissor=function(y){return y.copy(P)},this.setScissor=function(y,I,z,N){y.isVector4?P.set(y.x,y.y,y.z,y.w):P.set(y,I,z,N),Rt.scissor(B.copy(P).multiplyScalar(W).floor())},this.getScissorTest=function(){return V},this.setScissorTest=function(y){Rt.setScissorTest(V=y)},this.setOpaqueSort=function(y){Q=y},this.setTransparentSort=function(y){X=y},this.getClearColor=function(y){return y.copy(ut.getClearColor())},this.setClearColor=function(){ut.setClearColor.apply(ut,arguments)},this.getClearAlpha=function(){return ut.getClearAlpha()},this.setClearAlpha=function(){ut.setClearAlpha.apply(ut,arguments)},this.clear=function(y=!0,I=!0,z=!0){let N=0;if(y){let H=!1;if(C!==null){const ft=C.texture.format;H=ft===Oo||ft===Fo||ft===No}if(H){const ft=C.texture.type,vt=ft===nn||ft===rn||ft===br||ft===dn||ft===Uo||ft===Io,Et=ut.getClearColor(),Tt=ut.getClearAlpha(),Nt=Et.r,yt=Et.g,Dt=Et.b;vt?(p[0]=Nt,p[1]=yt,p[2]=Dt,p[3]=Tt,D.clearBufferuiv(D.COLOR,0,p)):(v[0]=Nt,v[1]=yt,v[2]=Dt,v[3]=Tt,D.clearBufferiv(D.COLOR,0,v))}else N|=D.COLOR_BUFFER_BIT}I&&(N|=D.DEPTH_BUFFER_BIT),z&&(N|=D.STENCIL_BUFFER_BIT),D.clear(N)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){e.removeEventListener("webglcontextlost",rt,!1),e.removeEventListener("webglcontextrestored",it,!1),e.removeEventListener("webglcontextcreationerror",ht,!1),J.dispose(),nt.dispose(),Ot.dispose(),Wt.dispose(),le.dispose(),x.dispose(),Ct.dispose(),St.dispose(),O.dispose(),A.dispose(),A.removeEventListener("sessionstart",qt),A.removeEventListener("sessionend",ze),xt&&(xt.dispose(),xt=null),_e.stop()};function rt(y){y.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),M=!0}function it(){console.log("THREE.WebGLRenderer: Context Restored."),M=!1;const y=Yt.autoReset,I=ot.enabled,z=ot.autoUpdate,N=ot.needsUpdate,H=ot.type;bt(),Yt.autoReset=y,ot.enabled=I,ot.autoUpdate=z,ot.needsUpdate=N,ot.type=H}function ht(y){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",y.statusMessage)}function lt(y){const I=y.target;I.removeEventListener("dispose",lt),j(I)}function j(y){mt(y),Ot.remove(y)}function mt(y){const I=Ot.get(y).programs;I!==void 0&&(I.forEach(function(z){O.releaseProgram(z)}),y.isShaderMaterial&&O.releaseShaderCache(y))}this.renderBufferDirect=function(y,I,z,N,H,ft){I===null&&(I=Ht);const vt=H.isMesh&&H.matrixWorld.determinant()<0,Et=lp(y,I,z,N,H);Rt.setMaterial(N,vt);let Tt=z.index,Nt=1;if(N.wireframe===!0){if(Tt=E.getWireframeAttribute(z),Tt===void 0)return;Nt=2}const yt=z.drawRange,Dt=z.attributes.position;let $t=yt.start*Nt,Zt=(yt.start+yt.count)*Nt;ft!==null&&($t=Math.max($t,ft.start*Nt),Zt=Math.min(Zt,(ft.start+ft.count)*Nt)),Tt!==null?($t=Math.max($t,0),Zt=Math.min(Zt,Tt.count)):Dt!=null&&($t=Math.max($t,0),Zt=Math.min(Zt,Dt.count));const Le=Zt-$t;if(Le<0||Le===1/0)return;Ct.setup(H,N,Et,z,Tt);let Je,Jt=zt;if(Tt!==null&&(Je=de.get(Tt),Jt=tt,Jt.setIndex(Je)),H.isMesh)N.wireframe===!0?(Rt.setLineWidth(N.wireframeLinewidth*wt()),Jt.setMode(D.LINES)):Jt.setMode(D.TRIANGLES);else if(H.isLine){let Ft=N.linewidth;Ft===void 0&&(Ft=1),Rt.setLineWidth(Ft*wt()),H.isLineSegments?Jt.setMode(D.LINES):H.isLineLoop?Jt.setMode(D.LINE_LOOP):Jt.setMode(D.LINE_STRIP)}else H.isPoints?Jt.setMode(D.POINTS):H.isSprite&&Jt.setMode(D.TRIANGLES);if(H.isInstancedMesh)Jt.renderInstances($t,Le,H.count);else if(z.isInstancedBufferGeometry){const Ft=z._maxInstanceCount!==void 0?z._maxInstanceCount:1/0,uo=Math.min(z.instanceCount,Ft);Jt.renderInstances($t,Le,uo)}else Jt.render($t,Le)},this.compile=function(y,I){function z(N,H,ft){N.transparent===!0&&N.side===Ge&&N.forceSinglePass===!1?(N.side=be,N.needsUpdate=!0,sr(N,H,ft),N.side=Qe,N.needsUpdate=!0,sr(N,H,ft),N.side=Ge):sr(N,H,ft)}m=nt.get(y),m.init(),w.push(m),y.traverseVisible(function(N){N.isLight&&N.layers.test(I.layers)&&(m.pushLight(N),N.castShadow&&m.pushShadow(N))}),m.setupLights(g._useLegacyLights),y.traverse(function(N){const H=N.material;if(H)if(Array.isArray(H))for(let ft=0;ft<H.length;ft++){const vt=H[ft];z(vt,y,N)}else z(H,y,N)}),w.pop(),m=null};let kt=null;function ge(y){kt&&kt(y)}function qt(){_e.stop()}function ze(){_e.start()}const _e=new Xs;_e.setAnimationLoop(ge),typeof self<"u"&&_e.setContext(self),this.setAnimationLoop=function(y){kt=y,A.setAnimationLoop(y),y===null?_e.stop():_e.start()},A.addEventListener("sessionstart",qt),A.addEventListener("sessionend",ze),this.render=function(y,I){if(I!==void 0&&I.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(M===!0)return;y.matrixWorldAutoUpdate===!0&&y.updateMatrixWorld(),I.parent===null&&I.matrixWorldAutoUpdate===!0&&I.updateMatrixWorld(),A.enabled===!0&&A.isPresenting===!0&&(A.cameraAutoUpdate===!0&&A.updateCamera(I),I=A.getCamera()),y.isScene===!0&&y.onBeforeRender(g,y,I,C),m=nt.get(y,w.length),m.init(),w.push(m),F.multiplyMatrices(I.projectionMatrix,I.matrixWorldInverse),at.setFromProjectionMatrix(F),dt=this.localClippingEnabled,ct=pt.init(this.clippingPlanes,dt),_=J.get(y,u.length),_.init(),u.push(_),Na(y,I,0,g.sortObjects),_.finish(),g.sortObjects===!0&&_.sort(Q,X),this.info.render.frame++,ct===!0&&pt.beginShadows();const z=m.state.shadowsArray;if(ot.render(z,y,I),ct===!0&&pt.endShadows(),this.info.autoReset===!0&&this.info.reset(),ut.render(_,y),m.setupLights(g._useLegacyLights),I.isArrayCamera){const N=I.cameras;for(let H=0,ft=N.length;H<ft;H++){const vt=N[H];Fa(_,y,vt,vt.viewport)}}else Fa(_,y,I);C!==null&&(It.updateMultisampleRenderTarget(C),It.updateRenderTargetMipmap(C)),y.isScene===!0&&y.onAfterRender(g,y,I),Ct.resetDefaultState(),U=-1,b=null,w.pop(),w.length>0?m=w[w.length-1]:m=null,u.pop(),u.length>0?_=u[u.length-1]:_=null};function Na(y,I,z,N){if(y.visible===!1)return;if(y.layers.test(I.layers)){if(y.isGroup)z=y.renderOrder;else if(y.isLOD)y.autoUpdate===!0&&y.update(I);else if(y.isLight)m.pushLight(y),y.castShadow&&m.pushShadow(y);else if(y.isSprite){if(!y.frustumCulled||at.intersectsSprite(y)){N&&_t.setFromMatrixPosition(y.matrixWorld).applyMatrix4(F);const vt=x.update(y),Et=y.material;Et.visible&&_.push(y,vt,Et,z,_t.z,null)}}else if((y.isMesh||y.isLine||y.isPoints)&&(!y.frustumCulled||at.intersectsObject(y))){const vt=x.update(y),Et=y.material;if(N&&(y.boundingSphere!==void 0?(y.boundingSphere===null&&y.computeBoundingSphere(),_t.copy(y.boundingSphere.center)):(vt.boundingSphere===null&&vt.computeBoundingSphere(),_t.copy(vt.boundingSphere.center)),_t.applyMatrix4(y.matrixWorld).applyMatrix4(F)),Array.isArray(Et)){const Tt=vt.groups;for(let Nt=0,yt=Tt.length;Nt<yt;Nt++){const Dt=Tt[Nt],$t=Et[Dt.materialIndex];$t&&$t.visible&&_.push(y,vt,$t,z,_t.z,Dt)}}else Et.visible&&_.push(y,vt,Et,z,_t.z,null)}}const ft=y.children;for(let vt=0,Et=ft.length;vt<Et;vt++)Na(ft[vt],I,z,N)}function Fa(y,I,z,N){const H=y.opaque,ft=y.transmissive,vt=y.transparent;m.setupLightsView(z),ct===!0&&pt.setGlobalState(g.clippingPlanes,z),ft.length>0&&ap(H,ft,I,z),N&&Rt.viewport(T.copy(N)),H.length>0&&or(H,I,z),ft.length>0&&or(ft,I,z),vt.length>0&&or(vt,I,z),Rt.buffers.depth.setTest(!0),Rt.buffers.depth.setMask(!0),Rt.buffers.color.setMask(!0),Rt.setPolygonOffset(!1)}function ap(y,I,z,N){const H=Pt.isWebGL2;xt===null&&(xt=new mn(1,1,{generateMipmaps:!0,type:gt.has("EXT_color_buffer_half_float")?di:nn,minFilter:ui,samples:H?4:0})),g.getDrawingBufferSize(Z),H?xt.setSize(Z.x,Z.y):xt.setSize(ki(Z.x),ki(Z.y));const ft=g.getRenderTarget();g.setRenderTarget(xt),g.getClearColor(K),L=g.getClearAlpha(),L<1&&g.setClearColor(16777215,.5),g.clear();const vt=g.toneMapping;g.toneMapping=en,or(y,z,N),It.updateMultisampleRenderTarget(xt),It.updateRenderTargetMipmap(xt);let Et=!1;for(let Tt=0,Nt=I.length;Tt<Nt;Tt++){const yt=I[Tt],Dt=yt.object,$t=yt.geometry,Zt=yt.material,Le=yt.group;if(Zt.side===Ge&&Dt.layers.test(N.layers)){const Je=Zt.side;Zt.side=be,Zt.needsUpdate=!0,Oa(Dt,z,N,$t,Zt,Le),Zt.side=Je,Zt.needsUpdate=!0,Et=!0}}Et===!0&&(It.updateMultisampleRenderTarget(xt),It.updateRenderTargetMipmap(xt)),g.setRenderTarget(ft),g.setClearColor(K,L),g.toneMapping=vt}function or(y,I,z){const N=I.isScene===!0?I.overrideMaterial:null;for(let H=0,ft=y.length;H<ft;H++){const vt=y[H],Et=vt.object,Tt=vt.geometry,Nt=N===null?vt.material:N,yt=vt.group;Et.layers.test(z.layers)&&Oa(Et,I,z,Tt,Nt,yt)}}function Oa(y,I,z,N,H,ft){y.onBeforeRender(g,I,z,N,H,ft),y.modelViewMatrix.multiplyMatrices(z.matrixWorldInverse,y.matrixWorld),y.normalMatrix.getNormalMatrix(y.modelViewMatrix),H.onBeforeRender(g,I,z,N,y,ft),H.transparent===!0&&H.side===Ge&&H.forceSinglePass===!1?(H.side=be,H.needsUpdate=!0,g.renderBufferDirect(z,I,N,H,y,ft),H.side=Qe,H.needsUpdate=!0,g.renderBufferDirect(z,I,N,H,y,ft),H.side=Ge):g.renderBufferDirect(z,I,N,H,y,ft),y.onAfterRender(g,I,z,N,H,ft)}function sr(y,I,z){I.isScene!==!0&&(I=Ht);const N=Ot.get(y),H=m.state.lights,ft=m.state.shadowsArray,vt=H.state.version,Et=O.getParameters(y,H.state,ft,I,z),Tt=O.getProgramCacheKey(Et);let Nt=N.programs;N.environment=y.isMeshStandardMaterial?I.environment:null,N.fog=I.fog,N.envMap=(y.isMeshStandardMaterial?le:Wt).get(y.envMap||N.environment),Nt===void 0&&(y.addEventListener("dispose",lt),Nt=new Map,N.programs=Nt);let yt=Nt.get(Tt);if(yt!==void 0){if(N.currentProgram===yt&&N.lightsStateVersion===vt)return Ba(y,Et),yt}else Et.uniforms=O.getUniforms(y),y.onBuild(z,Et,g),y.onBeforeCompile(Et,g),yt=O.acquireProgram(Et,Tt),Nt.set(Tt,yt),N.uniforms=Et.uniforms;const Dt=N.uniforms;(!y.isShaderMaterial&&!y.isRawShaderMaterial||y.clipping===!0)&&(Dt.clippingPlanes=pt.uniform),Ba(y,Et),N.needsLights=up(y),N.lightsStateVersion=vt,N.needsLights&&(Dt.ambientLightColor.value=H.state.ambient,Dt.lightProbe.value=H.state.probe,Dt.directionalLights.value=H.state.directional,Dt.directionalLightShadows.value=H.state.directionalShadow,Dt.spotLights.value=H.state.spot,Dt.spotLightShadows.value=H.state.spotShadow,Dt.rectAreaLights.value=H.state.rectArea,Dt.ltc_1.value=H.state.rectAreaLTC1,Dt.ltc_2.value=H.state.rectAreaLTC2,Dt.pointLights.value=H.state.point,Dt.pointLightShadows.value=H.state.pointShadow,Dt.hemisphereLights.value=H.state.hemi,Dt.directionalShadowMap.value=H.state.directionalShadowMap,Dt.directionalShadowMatrix.value=H.state.directionalShadowMatrix,Dt.spotShadowMap.value=H.state.spotShadowMap,Dt.spotLightMatrix.value=H.state.spotLightMatrix,Dt.spotLightMap.value=H.state.spotLightMap,Dt.pointShadowMap.value=H.state.pointShadowMap,Dt.pointShadowMatrix.value=H.state.pointShadowMatrix);const $t=yt.getUniforms(),Zt=nr.seqWithValue($t.seq,Dt);return N.currentProgram=yt,N.uniformsList=Zt,yt}function Ba(y,I){const z=Ot.get(y);z.outputColorSpace=I.outputColorSpace,z.instancing=I.instancing,z.instancingColor=I.instancingColor,z.skinning=I.skinning,z.morphTargets=I.morphTargets,z.morphNormals=I.morphNormals,z.morphColors=I.morphColors,z.morphTargetsCount=I.morphTargetsCount,z.numClippingPlanes=I.numClippingPlanes,z.numIntersection=I.numClipIntersection,z.vertexAlphas=I.vertexAlphas,z.vertexTangents=I.vertexTangents,z.toneMapping=I.toneMapping}function lp(y,I,z,N,H){I.isScene!==!0&&(I=Ht),It.resetTextureUnits();const ft=I.fog,vt=N.isMeshStandardMaterial?I.environment:null,Et=C===null?g.outputColorSpace:C.isXRRenderTarget===!0?C.texture.colorSpace:Ve,Tt=(N.isMeshStandardMaterial?le:Wt).get(N.envMap||vt),Nt=N.vertexColors===!0&&!!z.attributes.color&&z.attributes.color.itemSize===4,yt=!!z.attributes.tangent&&(!!N.normalMap||N.anisotropy>0),Dt=!!z.morphAttributes.position,$t=!!z.morphAttributes.normal,Zt=!!z.morphAttributes.color;let Le=en;N.toneMapped&&(C===null||C.isXRRenderTarget===!0)&&(Le=g.toneMapping);const Je=z.morphAttributes.position||z.morphAttributes.normal||z.morphAttributes.color,Jt=Je!==void 0?Je.length:0,Ft=Ot.get(N),uo=m.state.lights;if(ct===!0&&(dt===!0||y!==b)){const Se=y===b&&N.id===U;pt.setState(N,y,Se)}let Qt=!1;N.version===Ft.__version?(Ft.needsLights&&Ft.lightsStateVersion!==uo.state.version||Ft.outputColorSpace!==Et||H.isInstancedMesh&&Ft.instancing===!1||!H.isInstancedMesh&&Ft.instancing===!0||H.isSkinnedMesh&&Ft.skinning===!1||!H.isSkinnedMesh&&Ft.skinning===!0||H.isInstancedMesh&&Ft.instancingColor===!0&&H.instanceColor===null||H.isInstancedMesh&&Ft.instancingColor===!1&&H.instanceColor!==null||Ft.envMap!==Tt||N.fog===!0&&Ft.fog!==ft||Ft.numClippingPlanes!==void 0&&(Ft.numClippingPlanes!==pt.numPlanes||Ft.numIntersection!==pt.numIntersection)||Ft.vertexAlphas!==Nt||Ft.vertexTangents!==yt||Ft.morphTargets!==Dt||Ft.morphNormals!==$t||Ft.morphColors!==Zt||Ft.toneMapping!==Le||Pt.isWebGL2===!0&&Ft.morphTargetsCount!==Jt)&&(Qt=!0):(Qt=!0,Ft.__version=N.version);let Sn=Ft.currentProgram;Qt===!0&&(Sn=sr(N,I,H));let za=!1,yi=!1,ho=!1;const ve=Sn.getUniforms(),En=Ft.uniforms;if(Rt.useProgram(Sn.program)&&(za=!0,yi=!0,ho=!0),N.id!==U&&(U=N.id,yi=!0),za||b!==y){ve.setValue(D,"projectionMatrix",y.projectionMatrix),ve.setValue(D,"viewMatrix",y.matrixWorldInverse);const Se=ve.map.cameraPosition;Se!==void 0&&Se.setValue(D,_t.setFromMatrixPosition(y.matrixWorld)),Pt.logarithmicDepthBuffer&&ve.setValue(D,"logDepthBufFC",2/(Math.log(y.far+1)/Math.LN2)),(N.isMeshPhongMaterial||N.isMeshToonMaterial||N.isMeshLambertMaterial||N.isMeshBasicMaterial||N.isMeshStandardMaterial||N.isShaderMaterial)&&ve.setValue(D,"isOrthographic",y.isOrthographicCamera===!0),b!==y&&(b=y,yi=!0,ho=!0)}if(H.isSkinnedMesh){ve.setOptional(D,H,"bindMatrix"),ve.setOptional(D,H,"bindMatrixInverse");const Se=H.skeleton;Se&&(Pt.floatVertexTextures?(Se.boneTexture===null&&Se.computeBoneTexture(),ve.setValue(D,"boneTexture",Se.boneTexture,It),ve.setValue(D,"boneTextureSize",Se.boneTextureSize)):console.warn("THREE.WebGLRenderer: SkinnedMesh can only be used with WebGL 2. With WebGL 1 OES_texture_float and vertex textures support is required."))}const fo=z.morphAttributes;if((fo.position!==void 0||fo.normal!==void 0||fo.color!==void 0&&Pt.isWebGL2===!0)&&Mt.update(H,z,Sn),(yi||Ft.receiveShadow!==H.receiveShadow)&&(Ft.receiveShadow=H.receiveShadow,ve.setValue(D,"receiveShadow",H.receiveShadow)),N.isMeshGouraudMaterial&&N.envMap!==null&&(En.envMap.value=Tt,En.flipEnvMap.value=Tt.isCubeTexture&&Tt.isRenderTargetTexture===!1?-1:1),yi&&(ve.setValue(D,"toneMappingExposure",g.toneMappingExposure),Ft.needsLights&&cp(En,ho),ft&&N.fog===!0&&et.refreshFogUniforms(En,ft),et.refreshMaterialUniforms(En,N,W,Y,xt),nr.upload(D,Ft.uniformsList,En,It)),N.isShaderMaterial&&N.uniformsNeedUpdate===!0&&(nr.upload(D,Ft.uniformsList,En,It),N.uniformsNeedUpdate=!1),N.isSpriteMaterial&&ve.setValue(D,"center",H.center),ve.setValue(D,"modelViewMatrix",H.modelViewMatrix),ve.setValue(D,"normalMatrix",H.normalMatrix),ve.setValue(D,"modelMatrix",H.matrixWorld),N.isShaderMaterial||N.isRawShaderMaterial){const Se=N.uniformsGroups;for(let po=0,dp=Se.length;po<dp;po++)if(Pt.isWebGL2){const Ha=Se[po];St.update(Ha,Sn),St.bind(Ha,Sn)}else console.warn("THREE.WebGLRenderer: Uniform Buffer Objects can only be used with WebGL 2.")}return Sn}function cp(y,I){y.ambientLightColor.needsUpdate=I,y.lightProbe.needsUpdate=I,y.directionalLights.needsUpdate=I,y.directionalLightShadows.needsUpdate=I,y.pointLights.needsUpdate=I,y.pointLightShadows.needsUpdate=I,y.spotLights.needsUpdate=I,y.spotLightShadows.needsUpdate=I,y.rectAreaLights.needsUpdate=I,y.hemisphereLights.needsUpdate=I}function up(y){return y.isMeshLambertMaterial||y.isMeshToonMaterial||y.isMeshPhongMaterial||y.isMeshStandardMaterial||y.isShadowMaterial||y.isShaderMaterial&&y.lights===!0}this.getActiveCubeFace=function(){return S},this.getActiveMipmapLevel=function(){return R},this.getRenderTarget=function(){return C},this.setRenderTargetTextures=function(y,I,z){Ot.get(y.texture).__webglTexture=I,Ot.get(y.depthTexture).__webglTexture=z;const N=Ot.get(y);N.__hasExternalTextures=!0,N.__hasExternalTextures&&(N.__autoAllocateDepthBuffer=z===void 0,N.__autoAllocateDepthBuffer||gt.has("WEBGL_multisampled_render_to_texture")===!0&&(console.warn("THREE.WebGLRenderer: Render-to-texture extension was disabled because an external texture was provided"),N.__useRenderToTexture=!1))},this.setRenderTargetFramebuffer=function(y,I){const z=Ot.get(y);z.__webglFramebuffer=I,z.__useDefaultFramebuffer=I===void 0},this.setRenderTarget=function(y,I=0,z=0){C=y,S=I,R=z;let N=!0,H=null,ft=!1,vt=!1;if(y){const Tt=Ot.get(y);Tt.__useDefaultFramebuffer!==void 0?(Rt.bindFramebuffer(D.FRAMEBUFFER,null),N=!1):Tt.__webglFramebuffer===void 0?It.setupRenderTarget(y):Tt.__hasExternalTextures&&It.rebindTextures(y,Ot.get(y.texture).__webglTexture,Ot.get(y.depthTexture).__webglTexture);const Nt=y.texture;(Nt.isData3DTexture||Nt.isDataArrayTexture||Nt.isCompressedArrayTexture)&&(vt=!0);const yt=Ot.get(y).__webglFramebuffer;y.isWebGLCubeRenderTarget?(Array.isArray(yt[I])?H=yt[I][z]:H=yt[I],ft=!0):Pt.isWebGL2&&y.samples>0&&It.useMultisampledRTT(y)===!1?H=Ot.get(y).__webglMultisampledFramebuffer:Array.isArray(yt)?H=yt[z]:H=yt,T.copy(y.viewport),B.copy(y.scissor),q=y.scissorTest}else T.copy($).multiplyScalar(W).floor(),B.copy(P).multiplyScalar(W).floor(),q=V;if(Rt.bindFramebuffer(D.FRAMEBUFFER,H)&&Pt.drawBuffers&&N&&Rt.drawBuffers(y,H),Rt.viewport(T),Rt.scissor(B),Rt.setScissorTest(q),ft){const Tt=Ot.get(y.texture);D.framebufferTexture2D(D.FRAMEBUFFER,D.COLOR_ATTACHMENT0,D.TEXTURE_CUBE_MAP_POSITIVE_X+I,Tt.__webglTexture,z)}else if(vt){const Tt=Ot.get(y.texture),Nt=I||0;D.framebufferTextureLayer(D.FRAMEBUFFER,D.COLOR_ATTACHMENT0,Tt.__webglTexture,z||0,Nt)}U=-1},this.readRenderTargetPixels=function(y,I,z,N,H,ft,vt){if(!(y&&y.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Et=Ot.get(y).__webglFramebuffer;if(y.isWebGLCubeRenderTarget&&vt!==void 0&&(Et=Et[vt]),Et){Rt.bindFramebuffer(D.FRAMEBUFFER,Et);try{const Tt=y.texture,Nt=Tt.format,yt=Tt.type;if(Nt!==De&&Vt.convert(Nt)!==D.getParameter(D.IMPLEMENTATION_COLOR_READ_FORMAT)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}const Dt=yt===di&&(gt.has("EXT_color_buffer_half_float")||Pt.isWebGL2&&gt.has("EXT_color_buffer_float"));if(yt!==nn&&Vt.convert(yt)!==D.getParameter(D.IMPLEMENTATION_COLOR_READ_TYPE)&&!(yt===on&&(Pt.isWebGL2||gt.has("OES_texture_float")||gt.has("WEBGL_color_buffer_float")))&&!Dt){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}I>=0&&I<=y.width-N&&z>=0&&z<=y.height-H&&D.readPixels(I,z,N,H,Vt.convert(Nt),Vt.convert(yt),ft)}finally{const Tt=C!==null?Ot.get(C).__webglFramebuffer:null;Rt.bindFramebuffer(D.FRAMEBUFFER,Tt)}}},this.copyFramebufferToTexture=function(y,I,z=0){const N=Math.pow(2,-z),H=Math.floor(I.image.width*N),ft=Math.floor(I.image.height*N);It.setTexture2D(I,0),D.copyTexSubImage2D(D.TEXTURE_2D,z,0,0,y.x,y.y,H,ft),Rt.unbindTexture()},this.copyTextureToTexture=function(y,I,z,N=0){const H=I.image.width,ft=I.image.height,vt=Vt.convert(z.format),Et=Vt.convert(z.type);It.setTexture2D(z,0),D.pixelStorei(D.UNPACK_FLIP_Y_WEBGL,z.flipY),D.pixelStorei(D.UNPACK_PREMULTIPLY_ALPHA_WEBGL,z.premultiplyAlpha),D.pixelStorei(D.UNPACK_ALIGNMENT,z.unpackAlignment),I.isDataTexture?D.texSubImage2D(D.TEXTURE_2D,N,y.x,y.y,H,ft,vt,Et,I.image.data):I.isCompressedTexture?D.compressedTexSubImage2D(D.TEXTURE_2D,N,y.x,y.y,I.mipmaps[0].width,I.mipmaps[0].height,vt,I.mipmaps[0].data):D.texSubImage2D(D.TEXTURE_2D,N,y.x,y.y,vt,Et,I.image),N===0&&z.generateMipmaps&&D.generateMipmap(D.TEXTURE_2D),Rt.unbindTexture()},this.copyTextureToTexture3D=function(y,I,z,N,H=0){if(g.isWebGL1Renderer){console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: can only be used with WebGL2.");return}const ft=y.max.x-y.min.x+1,vt=y.max.y-y.min.y+1,Et=y.max.z-y.min.z+1,Tt=Vt.convert(N.format),Nt=Vt.convert(N.type);let yt;if(N.isData3DTexture)It.setTexture3D(N,0),yt=D.TEXTURE_3D;else if(N.isDataArrayTexture)It.setTexture2DArray(N,0),yt=D.TEXTURE_2D_ARRAY;else{console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: only supports THREE.DataTexture3D and THREE.DataTexture2DArray.");return}D.pixelStorei(D.UNPACK_FLIP_Y_WEBGL,N.flipY),D.pixelStorei(D.UNPACK_PREMULTIPLY_ALPHA_WEBGL,N.premultiplyAlpha),D.pixelStorei(D.UNPACK_ALIGNMENT,N.unpackAlignment);const Dt=D.getParameter(D.UNPACK_ROW_LENGTH),$t=D.getParameter(D.UNPACK_IMAGE_HEIGHT),Zt=D.getParameter(D.UNPACK_SKIP_PIXELS),Le=D.getParameter(D.UNPACK_SKIP_ROWS),Je=D.getParameter(D.UNPACK_SKIP_IMAGES),Jt=z.isCompressedTexture?z.mipmaps[0]:z.image;D.pixelStorei(D.UNPACK_ROW_LENGTH,Jt.width),D.pixelStorei(D.UNPACK_IMAGE_HEIGHT,Jt.height),D.pixelStorei(D.UNPACK_SKIP_PIXELS,y.min.x),D.pixelStorei(D.UNPACK_SKIP_ROWS,y.min.y),D.pixelStorei(D.UNPACK_SKIP_IMAGES,y.min.z),z.isDataTexture||z.isData3DTexture?D.texSubImage3D(yt,H,I.x,I.y,I.z,ft,vt,Et,Tt,Nt,Jt.data):z.isCompressedArrayTexture?(console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: untested support for compressed srcTexture."),D.compressedTexSubImage3D(yt,H,I.x,I.y,I.z,ft,vt,Et,Tt,Jt.data)):D.texSubImage3D(yt,H,I.x,I.y,I.z,ft,vt,Et,Tt,Nt,Jt),D.pixelStorei(D.UNPACK_ROW_LENGTH,Dt),D.pixelStorei(D.UNPACK_IMAGE_HEIGHT,$t),D.pixelStorei(D.UNPACK_SKIP_PIXELS,Zt),D.pixelStorei(D.UNPACK_SKIP_ROWS,Le),D.pixelStorei(D.UNPACK_SKIP_IMAGES,Je),H===0&&N.generateMipmaps&&D.generateMipmap(yt),Rt.unbindTexture()},this.initTexture=function(y){y.isCubeTexture?It.setTextureCube(y,0):y.isData3DTexture?It.setTexture3D(y,0):y.isDataArrayTexture||y.isCompressedArrayTexture?It.setTexture2DArray(y,0):It.setTexture2D(y,0),Rt.unbindTexture()},this.resetState=function(){S=0,R=0,C=null,Rt.reset(),Ct.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return We}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(t){this._outputColorSpace=t;const e=this.getContext();e.drawingBufferColorSpace=t===Tr?"display-p3":"srgb",e.unpackColorSpace=Gt.workingColorSpace===Ei?"display-p3":"srgb"}get physicallyCorrectLights(){return console.warn("THREE.WebGLRenderer: The property .physicallyCorrectLights has been removed. Set renderer.useLegacyLights instead."),!this.useLegacyLights}set physicallyCorrectLights(t){console.warn("THREE.WebGLRenderer: The property .physicallyCorrectLights has been removed. Set renderer.useLegacyLights instead."),this.useLegacyLights=!t}get outputEncoding(){return console.warn("THREE.WebGLRenderer: Property .outputEncoding has been removed. Use .outputColorSpace instead."),this.outputColorSpace===oe?fn:us}set outputEncoding(t){console.warn("THREE.WebGLRenderer: Property .outputEncoding has been removed. Use .outputColorSpace instead."),this.outputColorSpace=t===fn?oe:Ve}get useLegacyLights(){return console.warn("THREE.WebGLRenderer: The property .useLegacyLights has been deprecated. Migrate your lighting according to the following guide: https://discourse.threejs.org/t/updates-to-lighting-in-three-js-r155/53733."),this._useLegacyLights}set useLegacyLights(t){console.warn("THREE.WebGLRenderer: The property .useLegacyLights has been deprecated. Migrate your lighting according to the following guide: https://discourse.threejs.org/t/updates-to-lighting-in-three-js-r155/53733."),this._useLegacyLights=t}}class Gf extends xa{}Gf.prototype.isWebGL1Renderer=!0;class Vf extends ie{constructor(){super(),this.isScene=!0,this.type="Scene",this.background=null,this.environment=null,this.fog=null,this.backgroundBlurriness=0,this.backgroundIntensity=1,this.overrideMaterial=null,typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}copy(t,e){return super.copy(t,e),t.background!==null&&(this.background=t.background.clone()),t.environment!==null&&(this.environment=t.environment.clone()),t.fog!==null&&(this.fog=t.fog.clone()),this.backgroundBlurriness=t.backgroundBlurriness,this.backgroundIntensity=t.backgroundIntensity,t.overrideMaterial!==null&&(this.overrideMaterial=t.overrideMaterial.clone()),this.matrixAutoUpdate=t.matrixAutoUpdate,this}toJSON(t){const e=super.toJSON(t);return this.fog!==null&&(e.object.fog=this.fog.toJSON()),this.backgroundBlurriness>0&&(e.object.backgroundBlurriness=this.backgroundBlurriness),this.backgroundIntensity!==1&&(e.object.backgroundIntensity=this.backgroundIntensity),e}}class ba extends $n{constructor(t){super(),this.isLineBasicMaterial=!0,this.type="LineBasicMaterial",this.color=new Bt(16777215),this.map=null,this.linewidth=1,this.linecap="round",this.linejoin="round",this.fog=!0,this.setValues(t)}copy(t){return super.copy(t),this.color.copy(t.color),this.map=t.map,this.linewidth=t.linewidth,this.linecap=t.linecap,this.linejoin=t.linejoin,this.fog=t.fog,this}}const wa=new k,ya=new k,Ma=new jt,no=new Ss,rr=new Ii;class Wf extends ie{constructor(t=new Ce,e=new ba){super(),this.isLine=!0,this.type="Line",this.geometry=t,this.material=e,this.updateMorphTargets()}copy(t,e){return super.copy(t,e),this.material=Array.isArray(t.material)?t.material.slice():t.material,this.geometry=t.geometry,this}computeLineDistances(){const t=this.geometry;if(t.index===null){const e=t.attributes.position,n=[0];for(let r=1,o=e.count;r<o;r++)wa.fromBufferAttribute(e,r-1),ya.fromBufferAttribute(e,r),n[r]=n[r-1],n[r]+=wa.distanceTo(ya);t.setAttribute("lineDistance",new se(n,1))}else console.warn("THREE.Line.computeLineDistances(): Computation only possible with non-indexed BufferGeometry.");return this}raycast(t,e){const n=this.geometry,r=this.matrixWorld,o=t.params.Line.threshold,a=n.drawRange;if(n.boundingSphere===null&&n.computeBoundingSphere(),rr.copy(n.boundingSphere),rr.applyMatrix4(r),rr.radius+=o,t.ray.intersectsSphere(rr)===!1)return;Ma.copy(r).invert(),no.copy(t.ray).applyMatrix4(Ma);const s=o/((this.scale.x+this.scale.y+this.scale.z)/3),l=s*s,c=new k,d=new k,f=new k,h=new k,p=this.isLineSegments?2:1,v=n.index,m=n.attributes.position;if(v!==null){const u=Math.max(0,a.start),w=Math.min(v.count,a.start+a.count);for(let g=u,M=w-1;g<M;g+=p){const S=v.getX(g),R=v.getX(g+1);if(c.fromBufferAttribute(m,S),d.fromBufferAttribute(m,R),no.distanceSqToSegment(c,d,h,f)>l)continue;h.applyMatrix4(this.matrixWorld);const U=t.ray.origin.distanceTo(h);U<t.near||U>t.far||e.push({distance:U,point:f.clone().applyMatrix4(this.matrixWorld),index:g,face:null,faceIndex:null,object:this})}}else{const u=Math.max(0,a.start),w=Math.min(m.count,a.start+a.count);for(let g=u,M=w-1;g<M;g+=p){if(c.fromBufferAttribute(m,g),d.fromBufferAttribute(m,g+1),no.distanceSqToSegment(c,d,h,f)>l)continue;h.applyMatrix4(this.matrixWorld);const R=t.ray.origin.distanceTo(h);R<t.near||R>t.far||e.push({distance:R,point:f.clone().applyMatrix4(this.matrixWorld),index:g,face:null,faceIndex:null,object:this})}}}updateMorphTargets(){const e=this.geometry.morphAttributes,n=Object.keys(e);if(n.length>0){const r=e[n[0]];if(r!==void 0){this.morphTargetInfluences=[],this.morphTargetDictionary={};for(let o=0,a=r.length;o<a;o++){const s=r[o].name||String(o);this.morphTargetInfluences.push(0),this.morphTargetDictionary[s]=o}}}}}const Sa=new k,Ea=new k;class Xf extends Wf{constructor(t,e){super(t,e),this.isLineSegments=!0,this.type="LineSegments"}computeLineDistances(){const t=this.geometry;if(t.index===null){const e=t.attributes.position,n=[];for(let r=0,o=e.count;r<o;r+=2)Sa.fromBufferAttribute(e,r),Ea.fromBufferAttribute(e,r+1),n[r]=r===0?0:n[r-1],n[r+1]=n[r]+Sa.distanceTo(Ea);t.setAttribute("lineDistance",new se(n,1))}else console.warn("THREE.LineSegments.computeLineDistances(): Computation only possible with non-indexed BufferGeometry.");return this}}class io extends Ce{constructor(t=[],e=[],n=1,r=0){super(),this.type="PolyhedronGeometry",this.parameters={vertices:t,indices:e,radius:n,detail:r};const o=[],a=[];s(r),c(n),d(),this.setAttribute("position",new se(o,3)),this.setAttribute("normal",new se(o.slice(),3)),this.setAttribute("uv",new se(a,2)),r===0?this.computeVertexNormals():this.normalizeNormals();function s(w){const g=new k,M=new k,S=new k;for(let R=0;R<e.length;R+=3)p(e[R+0],g),p(e[R+1],M),p(e[R+2],S),l(g,M,S,w)}function l(w,g,M,S){const R=S+1,C=[];for(let U=0;U<=R;U++){C[U]=[];const b=w.clone().lerp(M,U/R),T=g.clone().lerp(M,U/R),B=R-U;for(let q=0;q<=B;q++)q===0&&U===R?C[U][q]=b:C[U][q]=b.clone().lerp(T,q/B)}for(let U=0;U<R;U++)for(let b=0;b<2*(R-U)-1;b++){const T=Math.floor(b/2);b%2===0?(h(C[U][T+1]),h(C[U+1][T]),h(C[U][T])):(h(C[U][T+1]),h(C[U+1][T+1]),h(C[U+1][T]))}}function c(w){const g=new k;for(let M=0;M<o.length;M+=3)g.x=o[M+0],g.y=o[M+1],g.z=o[M+2],g.normalize().multiplyScalar(w),o[M+0]=g.x,o[M+1]=g.y,o[M+2]=g.z}function d(){const w=new k;for(let g=0;g<o.length;g+=3){w.x=o[g+0],w.y=o[g+1],w.z=o[g+2];const M=m(w)/2/Math.PI+.5,S=u(w)/Math.PI+.5;a.push(M,1-S)}v(),f()}function f(){for(let w=0;w<a.length;w+=6){const g=a[w+0],M=a[w+2],S=a[w+4],R=Math.max(g,M,S),C=Math.min(g,M,S);R>.9&&C<.1&&(g<.2&&(a[w+0]+=1),M<.2&&(a[w+2]+=1),S<.2&&(a[w+4]+=1))}}function h(w){o.push(w.x,w.y,w.z)}function p(w,g){const M=w*3;g.x=t[M+0],g.y=t[M+1],g.z=t[M+2]}function v(){const w=new k,g=new k,M=new k,S=new k,R=new At,C=new At,U=new At;for(let b=0,T=0;b<o.length;b+=9,T+=6){w.set(o[b+0],o[b+1],o[b+2]),g.set(o[b+3],o[b+4],o[b+5]),M.set(o[b+6],o[b+7],o[b+8]),R.set(a[T+0],a[T+1]),C.set(a[T+2],a[T+3]),U.set(a[T+4],a[T+5]),S.copy(w).add(g).add(M).divideScalar(3);const B=m(S);_(R,T+0,w,B),_(C,T+2,g,B),_(U,T+4,M,B)}}function _(w,g,M,S){S<0&&w.x===1&&(a[g]=w.x-1),M.x===0&&M.z===0&&(a[g]=S/2/Math.PI+.5)}function m(w){return Math.atan2(w.z,-w.x)}function u(w){return Math.atan2(-w.y,Math.sqrt(w.x*w.x+w.z*w.z))}}copy(t){return super.copy(t),this.parameters=Object.assign({},t.parameters),this}static fromJSON(t){return new io(t.vertices,t.indices,t.radius,t.details)}}class ro extends io{constructor(t=1,e=0){const n=(1+Math.sqrt(5))/2,r=[-1,n,0,1,n,0,-1,-n,0,1,-n,0,0,-1,n,0,1,n,0,-1,-n,0,1,-n,n,0,-1,n,0,1,-n,0,-1,-n,0,1],o=[0,11,5,0,5,1,0,1,7,0,7,10,0,10,11,1,5,9,5,11,4,11,10,2,10,7,6,7,1,8,3,9,4,3,4,2,3,2,6,3,6,8,3,8,9,4,9,5,2,4,11,6,2,10,8,6,7,9,8,1];super(r,o,t,e),this.type="IcosahedronGeometry",this.parameters={radius:t,detail:e}}static fromJSON(t){return new ro(t.radius,t.detail)}}class Ta extends $n{constructor(t){super(),this.isMeshPhongMaterial=!0,this.type="MeshPhongMaterial",this.color=new Bt(16777215),this.specular=new Bt(1118481),this.shininess=30,this.map=null,this.lightMap=null,this.lightMapIntensity=1,this.aoMap=null,this.aoMapIntensity=1,this.emissive=new Bt(0),this.emissiveIntensity=1,this.emissiveMap=null,this.bumpMap=null,this.bumpScale=1,this.normalMap=null,this.normalMapType=ds,this.normalScale=new At(1,1),this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.specularMap=null,this.alphaMap=null,this.envMap=null,this.combine=pr,this.reflectivity=1,this.refractionRatio=.98,this.wireframe=!1,this.wireframeLinewidth=1,this.wireframeLinecap="round",this.wireframeLinejoin="round",this.flatShading=!1,this.fog=!0,this.setValues(t)}copy(t){return super.copy(t),this.color.copy(t.color),this.specular.copy(t.specular),this.shininess=t.shininess,this.map=t.map,this.lightMap=t.lightMap,this.lightMapIntensity=t.lightMapIntensity,this.aoMap=t.aoMap,this.aoMapIntensity=t.aoMapIntensity,this.emissive.copy(t.emissive),this.emissiveMap=t.emissiveMap,this.emissiveIntensity=t.emissiveIntensity,this.bumpMap=t.bumpMap,this.bumpScale=t.bumpScale,this.normalMap=t.normalMap,this.normalMapType=t.normalMapType,this.normalScale.copy(t.normalScale),this.displacementMap=t.displacementMap,this.displacementScale=t.displacementScale,this.displacementBias=t.displacementBias,this.specularMap=t.specularMap,this.alphaMap=t.alphaMap,this.envMap=t.envMap,this.combine=t.combine,this.reflectivity=t.reflectivity,this.refractionRatio=t.refractionRatio,this.wireframe=t.wireframe,this.wireframeLinewidth=t.wireframeLinewidth,this.wireframeLinecap=t.wireframeLinecap,this.wireframeLinejoin=t.wireframeLinejoin,this.flatShading=t.flatShading,this.fog=t.fog,this}}const Aa={enabled:!1,files:{},add:function(i,t){this.enabled!==!1&&(this.files[i]=t)},get:function(i){if(this.enabled!==!1)return this.files[i]},remove:function(i){delete this.files[i]},clear:function(){this.files={}}};class qf{constructor(t,e,n){const r=this;let o=!1,a=0,s=0,l;const c=[];this.onStart=void 0,this.onLoad=t,this.onProgress=e,this.onError=n,this.itemStart=function(d){s++,o===!1&&r.onStart!==void 0&&r.onStart(d,a,s),o=!0},this.itemEnd=function(d){a++,r.onProgress!==void 0&&r.onProgress(d,a,s),a===s&&(o=!1,r.onLoad!==void 0&&r.onLoad())},this.itemError=function(d){r.onError!==void 0&&r.onError(d)},this.resolveURL=function(d){return l?l(d):d},this.setURLModifier=function(d){return l=d,this},this.addHandler=function(d,f){return c.push(d,f),this},this.removeHandler=function(d){const f=c.indexOf(d);return f!==-1&&c.splice(f,2),this},this.getHandler=function(d){for(let f=0,h=c.length;f<h;f+=2){const p=c[f],v=c[f+1];if(p.global&&(p.lastIndex=0),p.test(d))return v}return null}}}const Yf=new qf;class oo{constructor(t){this.manager=t!==void 0?t:Yf,this.crossOrigin="anonymous",this.withCredentials=!1,this.path="",this.resourcePath="",this.requestHeader={}}load(){}loadAsync(t,e){const n=this;return new Promise(function(r,o){n.load(t,r,e,o)})}parse(){}setCrossOrigin(t){return this.crossOrigin=t,this}setWithCredentials(t){return this.withCredentials=t,this}setPath(t){return this.path=t,this}setResourcePath(t){return this.resourcePath=t,this}setRequestHeader(t){return this.requestHeader=t,this}}oo.DEFAULT_MATERIAL_NAME="__DEFAULT";const Ke={};class jf extends Error{constructor(t,e){super(t),this.response=e}}class $f extends oo{constructor(t){super(t)}load(t,e,n,r){t===void 0&&(t=""),this.path!==void 0&&(t=this.path+t),t=this.manager.resolveURL(t);const o=Aa.get(t);if(o!==void 0)return this.manager.itemStart(t),setTimeout(()=>{e&&e(o),this.manager.itemEnd(t)},0),o;if(Ke[t]!==void 0){Ke[t].push({onLoad:e,onProgress:n,onError:r});return}Ke[t]=[],Ke[t].push({onLoad:e,onProgress:n,onError:r});const a=new Request(t,{headers:new Headers(this.requestHeader),credentials:this.withCredentials?"include":"same-origin"}),s=this.mimeType,l=this.responseType;fetch(a).then(c=>{if(c.status===200||c.status===0){if(c.status===0&&console.warn("THREE.FileLoader: HTTP Status 0 received."),typeof ReadableStream>"u"||c.body===void 0||c.body.getReader===void 0)return c;const d=Ke[t],f=c.body.getReader(),h=c.headers.get("Content-Length")||c.headers.get("X-File-Size"),p=h?parseInt(h):0,v=p!==0;let _=0;const m=new ReadableStream({start(u){w();function w(){f.read().then(({done:g,value:M})=>{if(g)u.close();else{_+=M.byteLength;const S=new ProgressEvent("progress",{lengthComputable:v,loaded:_,total:p});for(let R=0,C=d.length;R<C;R++){const U=d[R];U.onProgress&&U.onProgress(S)}u.enqueue(M),w()}})}}});return new Response(m)}else throw new jf(`fetch for "${c.url}" responded with ${c.status}: ${c.statusText}`,c)}).then(c=>{switch(l){case"arraybuffer":return c.arrayBuffer();case"blob":return c.blob();case"document":return c.text().then(d=>new DOMParser().parseFromString(d,s));case"json":return c.json();default:if(s===void 0)return c.text();{const f=/charset="?([^;"\s]*)"?/i.exec(s),h=f&&f[1]?f[1].toLowerCase():void 0,p=new TextDecoder(h);return c.arrayBuffer().then(v=>p.decode(v))}}}).then(c=>{Aa.add(t,c);const d=Ke[t];delete Ke[t];for(let f=0,h=d.length;f<h;f++){const p=d[f];p.onLoad&&p.onLoad(c)}}).catch(c=>{const d=Ke[t];if(d===void 0)throw this.manager.itemError(t),c;delete Ke[t];for(let f=0,h=d.length;f<h;f++){const p=d[f];p.onError&&p.onError(c)}this.manager.itemError(t)}).finally(()=>{this.manager.itemEnd(t)}),this.manager.itemStart(t)}setResponseType(t){return this.responseType=t,this}setMimeType(t){return this.mimeType=t,this}}class Zf extends ie{constructor(t,e=1){super(),this.isLight=!0,this.type="Light",this.color=new Bt(t),this.intensity=e}dispose(){}copy(t,e){return super.copy(t,e),this.color.copy(t.color),this.intensity=t.intensity,this}toJSON(t){const e=super.toJSON(t);return e.object.color=this.color.getHex(),e.object.intensity=this.intensity,this.groundColor!==void 0&&(e.object.groundColor=this.groundColor.getHex()),this.distance!==void 0&&(e.object.distance=this.distance),this.angle!==void 0&&(e.object.angle=this.angle),this.decay!==void 0&&(e.object.decay=this.decay),this.penumbra!==void 0&&(e.object.penumbra=this.penumbra),this.shadow!==void 0&&(e.object.shadow=this.shadow.toJSON()),e}}const so=new jt,Ra=new k,Ca=new k;class Kf{constructor(t){this.camera=t,this.bias=0,this.normalBias=0,this.radius=1,this.blurSamples=8,this.mapSize=new At(512,512),this.map=null,this.mapPass=null,this.matrix=new jt,this.autoUpdate=!0,this.needsUpdate=!1,this._frustum=new jr,this._frameExtents=new At(1,1),this._viewportCount=1,this._viewports=[new ne(0,0,1,1)]}getViewportCount(){return this._viewportCount}getFrustum(){return this._frustum}updateMatrices(t){const e=this.camera,n=this.matrix;Ra.setFromMatrixPosition(t.matrixWorld),e.position.copy(Ra),Ca.setFromMatrixPosition(t.target.matrixWorld),e.lookAt(Ca),e.updateMatrixWorld(),so.multiplyMatrices(e.projectionMatrix,e.matrixWorldInverse),this._frustum.setFromProjectionMatrix(so),n.set(.5,0,0,.5,0,.5,0,.5,0,0,.5,.5,0,0,0,1),n.multiply(so)}getViewport(t){return this._viewports[t]}getFrameExtents(){return this._frameExtents}dispose(){this.map&&this.map.dispose(),this.mapPass&&this.mapPass.dispose()}copy(t){return this.camera=t.camera.clone(),this.bias=t.bias,this.radius=t.radius,this.mapSize.copy(t.mapSize),this}clone(){return new this.constructor().copy(this)}toJSON(){const t={};return this.bias!==0&&(t.bias=this.bias),this.normalBias!==0&&(t.normalBias=this.normalBias),this.radius!==1&&(t.radius=this.radius),(this.mapSize.x!==512||this.mapSize.y!==512)&&(t.mapSize=this.mapSize.toArray()),t.camera=this.camera.toJSON(!1).object,delete t.camera.matrix,t}}class Jf extends Kf{constructor(){super(new qs(-5,5,5,-5,.5,500)),this.isDirectionalLightShadow=!0}}class ka extends Zf{constructor(t,e){super(t,e),this.isDirectionalLight=!0,this.type="DirectionalLight",this.position.copy(ie.DEFAULT_UP),this.updateMatrix(),this.target=new ie,this.shadow=new Jf}dispose(){this.shadow.dispose()}copy(t){return super.copy(t),this.target=t.target.clone(),this.shadow=t.shadow.clone(),this}}class Qf extends Xf{constructor(t=1){const e=[0,0,0,t,0,0,0,0,0,0,t,0,0,0,0,0,0,t],n=[1,0,0,1,.6,0,0,1,0,.6,1,0,0,0,1,0,.6,1],r=new Ce;r.setAttribute("position",new se(e,3)),r.setAttribute("color",new se(n,3));const o=new ba({vertexColors:!0,toneMapped:!1});super(r,o),this.type="AxesHelper"}setColors(t,e,n){const r=new Bt,o=this.geometry.attributes.color.array;return r.set(t),r.toArray(o,0),r.toArray(o,3),r.set(e),r.toArray(o,6),r.toArray(o,9),r.set(n),r.toArray(o,12),r.toArray(o,15),this.geometry.attributes.color.needsUpdate=!0,this}dispose(){this.geometry.dispose(),this.material.dispose()}}typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("register",{detail:{revision:dr}})),typeof window<"u"&&(window.__THREE__?console.warn("WARNING: Multiple instances of Three.js being imported."):window.__THREE__=dr);class La extends oo{constructor(t){super(t)}load(t,e,n,r){const o=this,a=new $f(o.manager);a.setPath(o.path),a.setRequestHeader(o.requestHeader),a.setWithCredentials(o.withCredentials),a.load(t,function(s){try{e(o.parse(s))}catch(l){r?r(l):console.error(l),o.manager.itemError(t)}},n,r)}parse(t){function e(p){return p.replace(/^\s\s*/,"").replace(/\s\s*$/,"")}function n(p){return p.charAt(0).toUpperCase()+p.slice(1).toLowerCase()}function r(p,v){return"s"+Math.min(p,v)+"e"+Math.max(p,v)}function o(p,v,_,m){const u=parseInt(h[m].slice(p,p+v));if(u){const w=r(_,u);d[w]===void 0&&(c.push([_-1,u-1,1]),d[w]=c.length-1)}}function a(){const p={geometryAtoms:new Ce,geometryBonds:new Ce,json:{atoms:l}},v=p.geometryAtoms,_=p.geometryBonds,m=[],u=[],w=[],g=new Bt;for(let M=0,S=l.length;M<S;M++){const R=l[M],C=R[0],U=R[1],b=R[2];m.push(C,U,b);const T=R[3][0]/255,B=R[3][1]/255,q=R[3][2]/255;g.set(T,B,q).convertSRGBToLinear(),u.push(g.r,g.g,g.b)}for(let M=0,S=c.length;M<S;M++){const R=c[M],C=R[0],U=R[1],b=f[C],T=f[U];let B=b[0],q=b[1],K=b[2];w.push(B,q,K),B=T[0],q=T[1],K=T[2],w.push(B,q,K)}return v.setAttribute("position",new se(m,3)),v.setAttribute("color",new se(u,3)),_.setAttribute("position",new se(w,3)),p}const s={h:[255,255,255],he:[217,255,255],li:[204,128,255],be:[194,255,0],b:[255,181,181],c:[144,144,144],n:[48,80,248],o:[255,13,13],f:[144,224,80],ne:[179,227,245],na:[171,92,242],mg:[138,255,0],al:[191,166,166],si:[240,200,160],p:[255,128,0],s:[255,255,48],cl:[31,240,31],ar:[128,209,227],k:[143,64,212],ca:[61,255,0],sc:[230,230,230],ti:[191,194,199],v:[166,166,171],cr:[138,153,199],mn:[156,122,199],fe:[224,102,51],co:[240,144,160],ni:[80,208,80],cu:[200,128,51],zn:[125,128,176],ga:[194,143,143],ge:[102,143,143],as:[189,128,227],se:[255,161,0],br:[166,41,41],kr:[92,184,209],rb:[112,46,176],sr:[0,255,0],y:[148,255,255],zr:[148,224,224],nb:[115,194,201],mo:[84,181,181],tc:[59,158,158],ru:[36,143,143],rh:[10,125,140],pd:[0,105,133],ag:[192,192,192],cd:[255,217,143],in:[166,117,115],sn:[102,128,128],sb:[158,99,181],te:[212,122,0],i:[148,0,148],xe:[66,158,176],cs:[87,23,143],ba:[0,201,0],la:[112,212,255],ce:[255,255,199],pr:[217,255,199],nd:[199,255,199],pm:[163,255,199],sm:[143,255,199],eu:[97,255,199],gd:[69,255,199],tb:[48,255,199],dy:[31,255,199],ho:[0,255,156],er:[0,230,117],tm:[0,212,82],yb:[0,191,56],lu:[0,171,36],hf:[77,194,255],ta:[77,166,255],w:[33,148,214],re:[38,125,171],os:[38,102,150],ir:[23,84,135],pt:[208,208,224],au:[255,209,35],hg:[184,184,208],tl:[166,84,77],pb:[87,89,97],bi:[158,79,181],po:[171,92,0],at:[117,79,69],rn:[66,130,150],fr:[66,0,102],ra:[0,125,0],ac:[112,171,250],th:[0,186,255],pa:[0,161,255],u:[0,143,255],np:[0,128,255],pu:[0,107,255],am:[84,92,242],cm:[120,92,227],bk:[138,79,227],cf:[161,54,212],es:[179,31,212],fm:[179,31,186],md:[179,13,166],no:[189,13,135],lr:[199,0,102],rf:[204,0,89],db:[209,0,79],sg:[217,0,69],bh:[224,0,56],hs:[230,0,46],mt:[235,0,38],ds:[235,0,38],rg:[235,0,38],cn:[235,0,38],uut:[235,0,38],uuq:[235,0,38],uup:[235,0,38],uuh:[235,0,38],uus:[235,0,38],uuo:[235,0,38]},l=[],c=[],d={},f={},h=t.split(`
`);for(let p=0,v=h.length;p<v;p++)if(h[p].slice(0,4)==="ATOM"||h[p].slice(0,6)==="HETATM"){const _=parseFloat(h[p].slice(30,37)),m=parseFloat(h[p].slice(38,45)),u=parseFloat(h[p].slice(46,53)),w=parseInt(h[p].slice(6,11))-1;let g=e(h[p].slice(76,78)).toLowerCase();g===""&&(g=e(h[p].slice(12,14)).toLowerCase());const M=[_,m,u,s[g],n(g)];l.push(M),f[w]=M}else if(h[p].slice(0,6)==="CONECT"){const _=parseInt(h[p].slice(6,11));o(11,5,_,p),o(16,5,_,p),o(21,5,_,p),o(26,5,_,p)}return a()}}class tp extends ie{constructor(t=document.createElement("div")){super(),this.isCSS2DObject=!0,this.element=t,this.element.style.position="absolute",this.element.style.userSelect="none",this.element.setAttribute("draggable",!1),this.center=new At(.5,.5),this.addEventListener("removed",function(){this.traverse(function(e){e.element instanceof Element&&e.element.parentNode!==null&&e.element.parentNode.removeChild(e.element)})})}copy(t,e){return super.copy(t,e),this.element=t.element.cloneNode(!0),this.center=t.center,this}}const ai=new k,Pa=new jt,Da=new jt,Ua=new k,Ia=new k;class ep{constructor(t={}){const e=this;let n,r,o,a;const s={objects:new WeakMap},l=t.element!==void 0?t.element:document.createElement("div");l.style.overflow="hidden",this.domElement=l,this.getSize=function(){return{width:n,height:r}},this.render=function(p,v){p.matrixWorldAutoUpdate===!0&&p.updateMatrixWorld(),v.parent===null&&v.matrixWorldAutoUpdate===!0&&v.updateMatrixWorld(),Pa.copy(v.matrixWorldInverse),Da.multiplyMatrices(v.projectionMatrix,Pa),c(p,p,v),h(p)},this.setSize=function(p,v){n=p,r=v,o=n/2,a=r/2,l.style.width=p+"px",l.style.height=v+"px"};function c(p,v,_){if(p.isCSS2DObject){ai.setFromMatrixPosition(p.matrixWorld),ai.applyMatrix4(Da);const m=p.visible===!0&&ai.z>=-1&&ai.z<=1&&p.layers.test(_.layers)===!0;if(p.element.style.display=m===!0?"":"none",m===!0){p.onBeforeRender(e,v,_);const w=p.element;w.style.transform="translate("+-100*p.center.x+"%,"+-100*p.center.y+"%)translate("+(ai.x*o+o)+"px,"+(-ai.y*a+a)+"px)",w.parentNode!==l&&l.appendChild(w),p.onAfterRender(e,v,_)}const u={distanceToCameraSquared:d(_,p)};s.objects.set(p,u)}for(let m=0,u=p.children.length;m<u;m++)c(p.children[m],v,_)}function d(p,v){return Ua.setFromMatrixPosition(p.matrixWorld),Ia.setFromMatrixPosition(v.matrixWorld),Ua.distanceToSquared(Ia)}function f(p){const v=[];return p.traverse(function(_){_.isCSS2DObject&&v.push(_)}),v}function h(p){const v=f(p).sort(function(m,u){if(m.renderOrder!==u.renderOrder)return u.renderOrder-m.renderOrder;const w=s.objects.get(m).distanceToCameraSquared,g=s.objects.get(u).distanceToCameraSquared;return w-g}),_=v.length;for(let m=0,u=v.length;m<u;m++)v[m].element.style.zIndex=_-m}}}const ao={type:"change"},lo={type:"start"},co={type:"end"};class np extends pn{constructor(t,e){super();const n=this,r={NONE:-1,ROTATE:0,ZOOM:1,PAN:2,TOUCH_ROTATE:3,TOUCH_ZOOM_PAN:4};this.object=t,this.domElement=e,this.domElement.style.touchAction="none",this.enabled=!0,this.screen={left:0,top:0,width:0,height:0},this.rotateSpeed=1,this.zoomSpeed=1.2,this.panSpeed=.3,this.noRotate=!1,this.noZoom=!1,this.noPan=!1,this.staticMoving=!1,this.dynamicDampingFactor=.2,this.minDistance=0,this.maxDistance=1/0,this.minZoom=0,this.maxZoom=1/0,this.keys=["KeyA","KeyS","KeyD"],this.mouseButtons={LEFT:hr.ROTATE,MIDDLE:hr.DOLLY,RIGHT:hr.PAN},this.target=new k;const o=1e-6,a=new k;let s=1,l=r.NONE,c=r.NONE,d=0,f=0,h=0;const p=new k,v=new At,_=new At,m=new k,u=new At,w=new At,g=new At,M=new At,S=[],R={};this.target0=this.target.clone(),this.position0=this.object.position.clone(),this.up0=this.object.up.clone(),this.zoom0=this.object.zoom,this.handleResize=function(){const F=n.domElement.getBoundingClientRect(),Z=n.domElement.ownerDocument.documentElement;n.screen.left=F.left+window.pageXOffset-Z.clientLeft,n.screen.top=F.top+window.pageYOffset-Z.clientTop,n.screen.width=F.width,n.screen.height=F.height};const C=function(){const F=new At;return function(_t,Ht){return F.set((_t-n.screen.left)/n.screen.width,(Ht-n.screen.top)/n.screen.height),F}}(),U=function(){const F=new At;return function(_t,Ht){return F.set((_t-n.screen.width*.5-n.screen.left)/(n.screen.width*.5),(n.screen.height+2*(n.screen.top-Ht))/n.screen.width),F}}();this.rotateCamera=function(){const F=new k,Z=new zn,_t=new k,Ht=new k,wt=new k,D=new k;return function(){D.set(_.x-v.x,_.y-v.y,0);let gt=D.length();gt?(p.copy(n.object.position).sub(n.target),_t.copy(p).normalize(),Ht.copy(n.object.up).normalize(),wt.crossVectors(Ht,_t).normalize(),Ht.setLength(_.y-v.y),wt.setLength(_.x-v.x),D.copy(Ht.add(wt)),F.crossVectors(D,p).normalize(),gt*=n.rotateSpeed,Z.setFromAxisAngle(F,gt),p.applyQuaternion(Z),n.object.up.applyQuaternion(Z),m.copy(F),h=gt):!n.staticMoving&&h&&(h*=Math.sqrt(1-n.dynamicDampingFactor),p.copy(n.object.position).sub(n.target),Z.setFromAxisAngle(m,h),p.applyQuaternion(Z),n.object.up.applyQuaternion(Z)),v.copy(_)}}(),this.zoomCamera=function(){let F;l===r.TOUCH_ZOOM_PAN?(F=d/f,d=f,n.object.isPerspectiveCamera?p.multiplyScalar(F):n.object.isOrthographicCamera?(n.object.zoom=ms.clamp(n.object.zoom/F,n.minZoom,n.maxZoom),s!==n.object.zoom&&n.object.updateProjectionMatrix()):console.warn("THREE.TrackballControls: Unsupported camera type")):(F=1+(w.y-u.y)*n.zoomSpeed,F!==1&&F>0&&(n.object.isPerspectiveCamera?p.multiplyScalar(F):n.object.isOrthographicCamera?(n.object.zoom=ms.clamp(n.object.zoom/F,n.minZoom,n.maxZoom),s!==n.object.zoom&&n.object.updateProjectionMatrix()):console.warn("THREE.TrackballControls: Unsupported camera type")),n.staticMoving?u.copy(w):u.y+=(w.y-u.y)*this.dynamicDampingFactor)},this.panCamera=function(){const F=new At,Z=new k,_t=new k;return function(){if(F.copy(M).sub(g),F.lengthSq()){if(n.object.isOrthographicCamera){const wt=(n.object.right-n.object.left)/n.object.zoom/n.domElement.clientWidth,D=(n.object.top-n.object.bottom)/n.object.zoom/n.domElement.clientWidth;F.x*=wt,F.y*=D}F.multiplyScalar(p.length()*n.panSpeed),_t.copy(p).cross(n.object.up).setLength(F.x),_t.add(Z.copy(n.object.up).setLength(F.y)),n.object.position.add(_t),n.target.add(_t),n.staticMoving?g.copy(M):g.add(F.subVectors(M,g).multiplyScalar(n.dynamicDampingFactor))}}}(),this.checkDistances=function(){(!n.noZoom||!n.noPan)&&(p.lengthSq()>n.maxDistance*n.maxDistance&&(n.object.position.addVectors(n.target,p.setLength(n.maxDistance)),u.copy(w)),p.lengthSq()<n.minDistance*n.minDistance&&(n.object.position.addVectors(n.target,p.setLength(n.minDistance)),u.copy(w)))},this.update=function(){p.subVectors(n.object.position,n.target),n.noRotate||n.rotateCamera(),n.noZoom||n.zoomCamera(),n.noPan||n.panCamera(),n.object.position.addVectors(n.target,p),n.object.isPerspectiveCamera?(n.checkDistances(),n.object.lookAt(n.target),a.distanceToSquared(n.object.position)>o&&(n.dispatchEvent(ao),a.copy(n.object.position))):n.object.isOrthographicCamera?(n.object.lookAt(n.target),(a.distanceToSquared(n.object.position)>o||s!==n.object.zoom)&&(n.dispatchEvent(ao),a.copy(n.object.position),s=n.object.zoom)):console.warn("THREE.TrackballControls: Unsupported camera type")},this.reset=function(){l=r.NONE,c=r.NONE,n.target.copy(n.target0),n.object.position.copy(n.position0),n.object.up.copy(n.up0),n.object.zoom=n.zoom0,n.object.updateProjectionMatrix(),p.subVectors(n.object.position,n.target),n.object.lookAt(n.target),n.dispatchEvent(ao),a.copy(n.object.position),s=n.object.zoom};function b(F){n.enabled!==!1&&(S.length===0&&(n.domElement.setPointerCapture(F.pointerId),n.domElement.addEventListener("pointermove",T),n.domElement.addEventListener("pointerup",B)),at(F),F.pointerType==="touch"?X(F):G(F))}function T(F){n.enabled!==!1&&(F.pointerType==="touch"?$(F):Y(F))}function B(F){n.enabled!==!1&&(F.pointerType==="touch"?P(F):W(),ct(F),S.length===0&&(n.domElement.releasePointerCapture(F.pointerId),n.domElement.removeEventListener("pointermove",T),n.domElement.removeEventListener("pointerup",B)))}function q(F){ct(F)}function K(F){n.enabled!==!1&&(window.removeEventListener("keydown",K),c===r.NONE&&(F.code===n.keys[r.ROTATE]&&!n.noRotate?c=r.ROTATE:F.code===n.keys[r.ZOOM]&&!n.noZoom?c=r.ZOOM:F.code===n.keys[r.PAN]&&!n.noPan&&(c=r.PAN)))}function L(){n.enabled!==!1&&(c=r.NONE,window.addEventListener("keydown",K))}function G(F){if(l===r.NONE)switch(F.button){case n.mouseButtons.LEFT:l=r.ROTATE;break;case n.mouseButtons.MIDDLE:l=r.ZOOM;break;case n.mouseButtons.RIGHT:l=r.PAN;break}const Z=c!==r.NONE?c:l;Z===r.ROTATE&&!n.noRotate?(_.copy(U(F.pageX,F.pageY)),v.copy(_)):Z===r.ZOOM&&!n.noZoom?(u.copy(C(F.pageX,F.pageY)),w.copy(u)):Z===r.PAN&&!n.noPan&&(g.copy(C(F.pageX,F.pageY)),M.copy(g)),n.dispatchEvent(lo)}function Y(F){const Z=c!==r.NONE?c:l;Z===r.ROTATE&&!n.noRotate?(v.copy(_),_.copy(U(F.pageX,F.pageY))):Z===r.ZOOM&&!n.noZoom?w.copy(C(F.pageX,F.pageY)):Z===r.PAN&&!n.noPan&&M.copy(C(F.pageX,F.pageY))}function W(){l=r.NONE,n.dispatchEvent(co)}function Q(F){if(n.enabled!==!1&&n.noZoom!==!0){switch(F.preventDefault(),F.deltaMode){case 2:u.y-=F.deltaY*.025;break;case 1:u.y-=F.deltaY*.01;break;default:u.y-=F.deltaY*25e-5;break}n.dispatchEvent(lo),n.dispatchEvent(co)}}function X(F){switch(dt(F),S.length){case 1:l=r.TOUCH_ROTATE,_.copy(U(S[0].pageX,S[0].pageY)),v.copy(_);break;default:l=r.TOUCH_ZOOM_PAN;const Z=S[0].pageX-S[1].pageX,_t=S[0].pageY-S[1].pageY;f=d=Math.sqrt(Z*Z+_t*_t);const Ht=(S[0].pageX+S[1].pageX)/2,wt=(S[0].pageY+S[1].pageY)/2;g.copy(C(Ht,wt)),M.copy(g);break}n.dispatchEvent(lo)}function $(F){switch(dt(F),S.length){case 1:v.copy(_),_.copy(U(F.pageX,F.pageY));break;default:const Z=xt(F),_t=F.pageX-Z.x,Ht=F.pageY-Z.y;f=Math.sqrt(_t*_t+Ht*Ht);const wt=(F.pageX+Z.x)/2,D=(F.pageY+Z.y)/2;M.copy(C(wt,D));break}}function P(F){switch(S.length){case 0:l=r.NONE;break;case 1:l=r.TOUCH_ROTATE,_.copy(U(F.pageX,F.pageY)),v.copy(_);break;case 2:l=r.TOUCH_ZOOM_PAN;for(let Z=0;Z<S.length;Z++)if(S[Z].pointerId!==F.pointerId){const _t=R[S[Z].pointerId];_.copy(U(_t.x,_t.y)),v.copy(_);break}break}n.dispatchEvent(co)}function V(F){n.enabled!==!1&&F.preventDefault()}function at(F){S.push(F)}function ct(F){delete R[F.pointerId];for(let Z=0;Z<S.length;Z++)if(S[Z].pointerId==F.pointerId){S.splice(Z,1);return}}function dt(F){let Z=R[F.pointerId];Z===void 0&&(Z=new At,R[F.pointerId]=Z),Z.set(F.pageX,F.pageY)}function xt(F){const Z=F.pointerId===S[0].pointerId?S[1]:S[0];return R[Z.pointerId]}this.dispose=function(){n.domElement.removeEventListener("contextmenu",V),n.domElement.removeEventListener("pointerdown",b),n.domElement.removeEventListener("pointercancel",q),n.domElement.removeEventListener("wheel",Q),n.domElement.removeEventListener("pointermove",T),n.domElement.removeEventListener("pointerup",B),window.removeEventListener("keydown",K),window.removeEventListener("keyup",L)},this.domElement.addEventListener("contextmenu",V),this.domElement.addEventListener("pointerdown",b),this.domElement.addEventListener("pointercancel",q),this.domElement.addEventListener("wheel",Q,{passive:!1}),window.addEventListener("keydown",K),window.addEventListener("keyup",L),this.handleResize(),this.update()}}class ip{constructor(t,e=!0){this.target=t||(()=>{let r=document.createElement("div");return r.classList.add("uikit-w-screen","uikit-h-screen"),document.body.appendChild(r),r})(),this.scene=this.initScene(),this.camera=this.initCamera(),this.renderer=this.initRenderer(),this.controls=this.initControls(),e&&this.scene.add(new Qf(1)),this.addLight();let n=this;window.addEventListener("resize",()=>{this.camera.aspect=n.getWidth()/n.getHeight(),this.camera.updateProjectionMatrix(),this.renderer.forEach(r=>{r.setSize(n.getWidth(),n.getHeight())})})}getWidth(){return this.target?this.target.clientWidth:window.innerWidth}getHeight(){return this.target?this.target.clientHeight:window.innerHeight}initScene(){return new Vf}initCamera(){let t=new ke(70,this.getWidth()/this.getHeight(),1,100);return t.position.z=10,t}initRenderer(){let t=new Map,e=new xa({antialias:!0});return e.setPixelRatio(window.devicePixelRatio),e.setSize(this.getWidth(),this.getHeight()),this.target.appendChild(e.domElement),t.set("default",e),t}addCSS2DRenderer(t){if(this.renderer.has(t))throw Error(`${t} already exist`);let e=new ep;e.setSize(this.getWidth(),this.getHeight()),e.domElement.style.position="absolute",e.domElement.style.top="0px",e.domElement.style.pointerEvents="none",this.target.appendChild(e.domElement),this.renderer.set(t,e)}initControls(){return new np(this.camera,this.renderer.get("default").domElement)}addLight(){let t=new ka(16777215,.8);t.position.set(1,1,1),this.scene.add(t);let e=new ka(16777215,.5);e.position.set(-1,-1,1),this.scene.add(e)}Animate(){let t=this;requestAnimationFrame(this.Animate.bind(this)),this.controls.update(),this.renderer.forEach(e=>{e.render(t.scene,t.camera)})}AddObj(t){this.scene.add(t)}SetBackgroundColor(t){t&&(this.scene.background=new Bt(t))}}function rp(i){let t;return{c(){t=Xa("div"),qa(t,"class","uikit-w-full uikit-h-full uikit-shadow-lg")},m(e,n){Wa(e,t,n),i[4](t)},p:An,i:An,o:An,d(e){e&&xo(t),i[4](null)}}}function op(i,t,e){let{model:n=""}=t,{urlmodel:r=""}=t,{backgroundColor:o=""}=t,a,s;const l=()=>{let _=new La;try{s=_.parse(n)}catch(m){console.log(m)}},c=()=>{new La().load(r,m=>{s=m})},d=()=>{if(!window)return;let _=new ip(a);_.addCSS2DRenderer("label"),_.SetBackgroundColor(o),f(_),h(_),p(_),_.Animate()},f=_=>{const m=s.geometryAtoms.getAttribute("position"),u=s.geometryAtoms.getAttribute("color");for(let w=0;w<m.count;w++){let g=new k;g.x=m.getX(w),g.y=m.getY(w),g.z=m.getZ(w);let M=new Bt;M.r=u.getX(w),M.g=u.getY(w),M.b=u.getZ(w);let S=new ro(.25,3),R=new Ta({color:M}),C=new Oe(S,R);C.position.copy(g),_.AddObj(C)}},h=_=>{const m=s.geometryBonds.getAttribute("position");for(let u=0;u<m.count;u+=2){let w=new k;w.x=m.getX(u),w.y=m.getY(u),w.z=m.getZ(u);let g=new k;g.x=m.getX(u+1),g.y=m.getY(u+1),g.z=m.getZ(u+1);let M=new ti(.05,.05,.05),S=new Ta({color:16777215}),R=new Oe(M,S);R.position.copy(w),R.position.lerp(g,.5),R.scale.z=w.distanceTo(g)*10,R.lookAt(g),_.AddObj(R)}},p=_=>{const m=s.json;for(let u of m.atoms){let w=document.createElement("div");w.style.color=`rgb(${u[3][0]}, ${u[3][1]}, ${u[3][2]})`,w.textContent=u[4];let g=new k;g.x=u[0],g.y=u[1],g.z=u[2];let M=new tp(w);M.position.copy(g),_.AddObj(M)}};$a(()=>{d()});function v(_){ar[_?"unshift":"push"](()=>{a=_,e(0,a)})}return i.$$set=_=>{"model"in _&&e(1,n=_.model),"urlmodel"in _&&e(2,r=_.urlmodel),"backgroundColor"in _&&e(3,o=_.backgroundColor)},i.$$.update=()=>{i.$$.dirty&2&&n&&l(),i.$$.dirty&4&&r&&c()},[a,n,r,o,v]}class sp extends sl{constructor(t){super(),ol(this,t,op,rp,Ga,{model:1,urlmodel:2,backgroundColor:3})}}Ee.PdbRender=sp,Object.defineProperty(Ee,Symbol.toStringTag,{value:"Module"})});
