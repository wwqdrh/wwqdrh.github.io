...
`].filter(Mi).join(`
`)),a=to(a),a=ha(a,e),a=fa(a,e),s=to(s),s=ha(s,e),s=fa(s,e),a=pa(a),s=pa(s),e.isWebGL2&&e.isRawShaderMaterial!==!0&&(M=`#version 300 es
